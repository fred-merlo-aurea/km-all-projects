...
namespace KM.Common.UserControls
{
    ...
    /// </summary>
    public partial class GridViewPager : GridView, IPageableItemContainer
    {
        /// <summary>
        ...
        {
            add { base.Events.AddHandler(GridViewPager.EventTotalRowCountAvailable, value); }
            remove { base.Events.RemoveHandler(GridViewPager.EventTotalRowCountAvailable, value); }
        }
        ...
        {
            EventHandler<PageEventArgs> handler = (EventHandler<PageEventArgs>)base.Events[GridViewPager.EventTotalRowCountAvailable];
            if (handler != null)
            {
                handler(this, e);
            }
