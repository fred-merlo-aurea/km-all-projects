...
namespace KM.Common.UserControls
{
    ...
    public partial class Pager : Control, IAttributeAccessor, INamingContainer
    {
        ...
        protected virtual void BindDefaultContent(Control control, string appURL)
        {
            ...
            else
            {
                ...
                if (this.ShowPagerItems && (this.TotalPages > 1))
                {
                    if (this.ShowFirst)
                    {
                        this.BindFirst(control, appURL);
                    }
                    if (this.ShowPrevious)
                    {
                        this.BindPrevious(control, appURL);
                    }
                    if (this.ShowIndividualPages)
                    {
                        this.BindPages(control, appURL);
                    }
                    if (this.ShowNext)
                    {
                        this.BindNext(control, appURL);
                    }
                    if (this.ShowLast)
                    {
                        this.BindLast(control, appURL);
                    }
                }
            }
        }
        ...
        /// </summary>
        /// <param name="control">Control</param>
        protected virtual void BindFirst(Control control, string appURL)
        {
            if ((this.PageIndex >= 3) && (this.TotalPages > this.IndividualPagesDisplayedCount))
            {
                ...
                child.NavigateUrl = this.GetPageNavigateUrl(1,appURL);
        ...
        /// </summary>
        /// <param name="control">Control</param>
        protected virtual void BindLast(Control control, string appURL)
        {
            if (((this.PageIndex + 3) < this.TotalPages) && (this.TotalPages > this.IndividualPagesDisplayedCount))
            {
                ...
                child.NavigateUrl = this.GetPageNavigateUrl(this.TotalPages, appURL);
                control.Controls.Add(child);
            }
        }
        ...
        /// </summary>
        /// <param name="control">Control</param>
        protected virtual void BindNext(Control control, string appURL)
        {
            if ((this.PageIndex + 1) < this.TotalPages)
            {
                ...
                child.NavigateUrl = this.GetPageNavigateUrl(this.PageIndex + 2, appURL);
                control.Controls.Add(child);
            }
        }
        ...
        /// </summary>
        /// <param name="control">Control</param>
        protected virtual void BindPages(Control control, string appURL)
        {
            ...
            for (int i = firstIndividualPageIndex; i <= lastIndividualPageIndex; i++)
            {
                ...
                else
                {
                    ...
                    child.NavigateUrl = this.GetPageNavigateUrl(i + 1, appURL);
                    control.Controls.Add(child);
                }
        ...
        /// </summary>
        /// <param name="control">Control</param>
        protected virtual void BindPrevious(Control control, string appURL)
        {
            if (this.PageIndex > 0)
            {
                HyperLink child = new HyperLink();
                child.Text = this.PreviousButtonText;
                child.NavigateUrl = this.GetPageNavigateUrl(this.PageIndex, appURL);
                control.Controls.Add(child);
        ...
        {
            return (WebFunctions.QueryStringInt(this.QueryStringProperty, 0) - 1);
        }
        ...
        /// <returns>Url</returns>
        protected virtual string GetPageNavigateUrl(int pageIndex, string appURL)
        {
            return WebFunctions.ModifyQueryString(WebFunctions.GetThisPageUrl(true, appURL), this.QueryStringProperty + "=" + pageIndex.ToString(), null);
        }
        ...
        public override void DataBind()
        {
            ...
            this.BindDefaultContent(this, appURL);
            base.DataBind();
