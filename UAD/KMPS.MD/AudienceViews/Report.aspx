<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report.aspx.cs" Inherits="KMPS.MD.Main.Report"
    MasterPageFile="../MasterPages/Site.Master" Async="true" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <style type="text/css">
        ...
        .RadPiviotGrid .rpgHorizontalScroll {
            overflow-x: scroll;
            overflow-y: scroll;
        }
    ...
    function rlbDimensionAvailable_OnClientTransferring(sender, e) {
        ...
        function ConfirmDelete() {
            if ($('#' + '<%=this.hfHasFilterSegmentation.ClientID%>').val() == 'true') {
                return confirm('Filter Segmentation exists, deleting will erase.');
        }
    }
    </script>
    <div>
        ...
        <asp:Panel ID="pnlErrorGeo" runat="server" Visible="false">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            ...
            <ContentTemplate>
                ...
                <asp:Label ID="lblIsFilterSegmentation" Visible="false" runat="server"></asp:Label>
                <asp:Label ID="lblAddFilters" Visible="false" runat="server"></asp:Label>
                <asp:Label ID="lblMasterID" Visible="false" runat="server"></asp:Label>
                    ...
                    <asp:Panel ID="pnlPopupRound" runat="server" Width="1000px" CssClass="modalPopup2">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                            <Triggers>
                                ...
                                <asp:AsyncPostBackTrigger ControlID="cbIncludePermissions" />
                            </Triggers>
                            <ContentTemplate>
                                <div align="center" style="text-align: center; height: 500px; overflow: scroll; padding: 0px 10px 0px 10px;">
                                    ...
                                    <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:DropDownList ID="drpDimension" runat="server" Width="250px" DataTextField="DisplayName" DataValueField="MasterGroupID" OnSelectedIndexChanged="drpDimension_SelectedIndexChanged" AutoPostBack="true">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    ...
                                                    <asp:Button ID="btnSearch" runat="server" CssClass="button" OnClick="btnSearch_Click"
                                                        Text="Search" />&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                                                    <asp:CheckBox ID="cbIncludePermissions" runat="server" Text=" Include Permissions"
                                                        Checked="false" OnCheckedChanged="cbIncludePermissions_CheckedChanged" AutoPostBack="true" />&nbsp; &nbsp;
                                                    ...
                                                    <asp:GridView ID="grdSubReport" runat="server" Width="400px" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="" HeaderStyle-Width="10px" ItemStyle-Width="10px"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="cbSelectDownload" runat="server" Text="" Checked="false" Visible='<%# Convert.ToInt32(Eval("ID")) == 0 || Convert.ToInt32(Eval("ID")) == -1 ? false : true %>' />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:BoundField DataField="Value" HeaderText="Value" HeaderStyle-HorizontalAlign="Center"
                                                                HeaderStyle-Width="10px" ItemStyle-Width="10px" SortExpression="Value" ItemStyle-Wrap="false">
                                                            ...
                                                            <asp:BoundField DataField="Desc1" HeaderText="" HeaderStyle-HorizontalAlign="Left"
                                            ...
                                            <tr>
                                                <td align="left" colspan="2">
                                                    <telerik:RadPivotGrid RenderMode="Lightweight" AllowPaging="false" PageSize="10" Height="365px" Width="955px" EnableAjaxSkinRendering="true"
                                                        ID="rpgCrossTab" runat="server" ColumnHeaderZoneText="ColumnHeaderZone" ShowColumnHeaderZone="false" ShowFilterHeaderZone="false" ShowDataHeaderZone="false" ShowRowHeaderZone="false" OnNeedDataSource="rpgCrossTab_NeedDataSource" OnCellDataBound="rpgCrossTab_CellDataBound" ColumnHeaderCellStyle-Width="150px">
                                                        ...
                                                        <ClientSettings EnableFieldsDragDrop="false" Resizing-AllowColumnResize="True">
                                        ...
                                        <tr>
                                            <td valign="middle" align="center">
                                                ...
                                                <asp:Label ID="lblFile" runat="server" Visible="false"></asp:Label><br />
                                                    ...
                                                    <asp:HiddenField ID="hfDataCompareLinkSelected" runat="server" Value="0" />
                                                    </td>
                                        </tr>
                                            ...
                                            <tr>
                                                <td valign="middle" align="center">
                                                    <table border="0" cellpadding="1" cellspacing="1" width="100%">
                                                        ...
                                                        <tr>
                                                            <td  align="right" >
                                                                <asp:Label ID="lblMatchedRecordHeader" runat="server" Text="Matched : "></asp:Label>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td  align="right">
                                                                <asp:Label ID="lblMatchedNotInHeader" runat="server" Text="Matched Not in <br/> Selected Brand : " Visible="false"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:LinkButton ID="lnkMatchedNotIn" runat="server" Text="" OnCommand="lnkDataCompare_Command" CommandArgument="MatchedNotInBrand" Visible="false" />
                                                            </td>
                                                            <td>
                                                                <asp:LinkButton ID="lnkMatchedNotInSummary" runat="server" Text="Summary" OnCommand="lnkDataCompareSummary_Command" CommandArgument="MatchedNotInBrand" Visible="false"></asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td  align="right">
                                                                <asp:Label ID="lblNonMatchedRecordsHeader" runat="server" Text="Non Matched : "></asp:Label>
                                                            </td>
                                                            <td>
                            ...
                            <td width="85%" valign="top" style="padding: 3px 3px 3px 3px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="*" MaximumValue="600"
                                                                MinimumValue="0" ControlToValidate="txtRadiusMin"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:RangeValidator ID="RangeValidator3" runat="server" ErrorMessage="*" MaximumValue="600"
                                                                MinimumValue="1" ControlToValidate="txtRadiusMax"
                                                                Type="Integer"></asp:RangeValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size: xx-small" align="middle" colspan="2">Range (0 to 600 miles)
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td valign="top" colspan="11">
                                                <table border="0" bordercolor="#cccccc" cellpadding="2" cellspacing="1" width="100%">
                                                    ...
                                                    <tr style="padding: 2px 0px 2px 0px; height: 20px;">
                                ...
                                <asp:Panel ID="pnlButtons" runat="server" BorderColor="#5783BD" BorderWidth="0">
                                    <table border="0" bordercolor="#cccccc" cellpadding="5" cellspacing="1" width="100%">
                                        <tr>
                                            <td align="center" valign="middle">
                                                <asp:Button ID="btnAddFilter" Text="Add Filters" runat="server" CssClass="button"   
                                                    OnClick="btnAddFilter_Click" ></asp:Button>
                                                &nbsp;
                                        ...
                                        <tr>
                                            <td align="center">
                                                <div id="divErrorMsg" runat="Server" visible="true">
                                                                                    ...
                                                                                    <asp:Panel ID="pnlResultHeader" runat="server" Height="28px" CssClass="collapsePanelHeader"
                                                                                        ...
                                                                                        <div style="padding: 5px; cursor: pointer; vertical-align: middle;">
                                                                                            ...
                                                                                            <div style="float: left; margin-left: 20px;">
                                                                                                ...
                                                                                                <asp:Label ID="pnlResultLabel" runat="server" Font-Bold="false">(Show Filters...)</asp:Label>
                                                                                            </div>
                                                                                            <div style="float: right; vertical-align: middle;">
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="#" HeaderStyle-Width="77%" ItemStyle-Width="77%" ItemStyle-HorizontalAlign="left"
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        ...
                                                                                                        <asp:Label ID="lblAdhocCondition" runat="server" Text='<%# Eval("name").ToString() == "Adhoc" || Eval("name").ToString() == "Open Activity" ||  Eval("name").ToString() == "Click Activity"  ||  Eval("name").ToString() == "Open Email Sent Date" ||  Eval("name").ToString() == "Click Email Sent Date" ||  Eval("name").ToString() == "Visit Activity" || Eval("name").ToString() == "Open Criteria" || Eval("name").ToString() == "Click Criteria"  ? Eval("name").ToString() == "Open Activity" ||  Eval("name").ToString() == "Click Activity" ||  Eval("name").ToString() == "Open Email Sent Date" ||  Eval("name").ToString() == "Click Email Sent Date" ||  Eval("name").ToString() == "Visit Activity" || Eval("name").ToString() == "Open Criteria" || Eval("name").ToString() == "Click Criteria"   ? Eval("name").ToString() == "Open Criteria" || Eval("name").ToString() == "Click Criteria" ? " - "  + Eval("SearchCondition") : Eval("SearchCondition")  + " - " + Eval("Values") :  " - " + Eval("SearchCondition") + " - " + Eval("Values") : "" %>'></asp:Label>
...
<%--                                                                                <FooterTemplate>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Remove" HeaderStyle-Width="2%" ItemStyle-Width="2%"
                                                                                ItemStyle-HorizontalAlign="center" ItemStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="center">
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton ID="lnkRemove" runat="server" CommandName="Delete" OnClientClick="javascript:return ConfirmDelete();"
                                                                                        Text="<img src='../images/icon-delete.gif' style='border:none;'>"> </asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
