...
namespace KMPS.MD.Administration
{
    public partial class AdhocSort : KMPS.MD.Main.WebPageHelper
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                List<AdhocCategory> ac = AdhocCategory.Get(Master.clientconnections);
                ...
                lstSourceFields.DataSource = Adhoc.GetByCategoryID(Master.clientconnections, 0, 0,0);
        ...
        protected void gvCategory_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                ...
                try
                {
                    List<AdhocCategory> ladhoccategory = AdhocCategory.Get(Master.clientconnections);
                    ...
                    lstDestFields.DataSource = Adhoc.GetByCategoryID(Master.clientconnections, CategoryID, 0,0);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (AdhocCategory.Exists(Master.clientconnections, txtCategoryName.Text))
                    {
                        divError.Visible = true;
                ...
                int CategoryID = AdhocCategory.Save(Master.clientconnections, Convert.ToInt32(lblCategoryID.Text), txtCategoryName.Text, Convert.ToInt32(drpSortingOrder.SelectedItem.Value));

                Adhoc.Delete(Master.clientconnections, CategoryID);
                ...
                foreach (ListItem li in lstDestFields.Items)
                {
                    ...
                    Adhoc.Save(Master.clientconnections, adhoc);
        ...
        protected void gvCategory_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                grdAdhoc.DataSource = Adhoc.GetByCategoryID(Master.clientconnections, Convert.ToInt32(gvCategory.DataKeys[e.Row.RowIndex].Value.ToString()),0,0);
                grdAdhoc.DataBind();
            }
        }
    }
