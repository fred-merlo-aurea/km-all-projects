<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="UserDataMaskSetUp.aspx.cs" Inherits="KMPS.MD.Tools.UserDataMaskSetUp" %>
        ...
        <ContentTemplate>
            <center>
                <div style="width: 90%; text-align: left; padding-left: 10px;">
                    <asp:GridView ID="gvUserDataMask" runat="server" AllowPaging="True" AllowSorting="false"
                        AutoGenerateColumns="False" DataKeyNames="UserID" OnPageIndexChanging="gvUserDataMask_PageIndexChanging"
                        OnRowDeleting="gvUserDataMask_RowDeleting" OnRowCommand="gvUserDataMask_RowCommand" OnRowDataBound="gvUserDataMask_OnRowDataBound">
                        <Columns>
                            <asp:BoundField DataField="UserName" HeaderText="User Name" SortExpression="UserName"
                                HeaderStyle-HorizontalAlign="Left">
                                <HeaderStyle HorizontalAlign="Left" Width="25%" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderStyle-Width="65%" ItemStyle-Width="65%" HeaderText="Selected Fields"
                                ItemStyle-HorizontalAlign="left" ItemStyle-VerticalAlign="Top" HeaderStyle-HorizontalAlign="left">
                                <ItemTemplate>
                                    <asp:Label ID="lblMaskFields" runat="server" Text="Label"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <asp:Panel ID="pnlHeader" runat="server" Style="background-color: #5783BD;" CssClass="collapsePanelHeader">
                        <div style="padding: 5px; cursor: pointer; vertical-align: middle;">
                            <div style="float: left;">
                                <asp:Label ID="lblpnlHeader" runat="Server">UserData Mask Setup</asp:Label>
                            </div>
                        </div>
                    </asp:Panel>
                                ...
                                <tr>
                                    <td>
                                        <asp:ListBox ID="lstSourceFields" runat="server" Rows="20" Style="text-transform: uppercase;"
                                            DataValueField="Value" DataTextField="Key" SelectionMode="Multiple"
