<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DownloadPanel_EV.ascx.cs" Inherits="KMPS.MD.Controls.DownloadPanel_EV" %>
                ...
                <div id="dvDownloads" align="center" style="text-align: center; padding: 10px 10px 10px 10px;"
                    ...
                    <table width="100%" border="0" cellpadding="5" cellspacing="5" style="border: solid 1px #5783BD; height: auto">
                        ...
                        <asp:Panel ID="pnlUADExport" runat="server">
                                ...
                                <td colspan="2">
                                    <table width="50%" border="0" cellpadding="5" cellspacing="5">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:ListBox ID="lstSelectedFields" runat="server" Rows="10" Style="text-transform: uppercase;"
                                                    SelectionMode="Multiple" Width="350px"
                            ...
                            <tr>
                                <td colspan="2" align="left">Total Unique Email Addresses&nbsp;&nbsp;
                                <asp:HiddenField ID="hfTotalUniqueCount" runat="server" />
                            ...
                            <tr>
                                <td style="padding: 10px" align="left" colspan="2">
                                    <asp:RadioButton ID="rbDownload" runat="Server" Text=" Download one record per email address" GroupName="grpSelect"
