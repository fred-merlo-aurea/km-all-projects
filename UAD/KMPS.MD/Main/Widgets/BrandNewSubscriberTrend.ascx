<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BrandNewSubscriberTrend.ascx.cs" Inherits="KMPS.MD.Main.Widgets.BrandNewSubscriberTrend" %>
    ...
    <ContentTemplate>
        ...
        <telerik:RadHtmlChart runat="server" ID="RadHtmlChart1" Width="800" Height="500" Transitions="true">
            ...
            <PlotArea>
                ...
                <XAxis DataLabelsField="MonthYearLabel" ></XAxis>
                <YAxis >
