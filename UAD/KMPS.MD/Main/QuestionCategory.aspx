<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="QuestionCategory.aspx.cs" Inherits="KMPS.MD.Main.QuestionCategory" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <center>
                ...
                <asp:Button ID="btnloadSaveQuestionCategoryPopup" runat="server" Style="display: none" />
                <asp:ModalPopupExtender ID="mdlPopSaveQuestionCategory" runat="server" TargetControlID="btnloadSaveQuestionCategoryPopup"
                    PopupControlID="pnlSaveQuestionCategory" BackgroundCssClass="modalBackground" />
                <asp:RoundedCornersExtender ID="RoundedCornersExtender6" runat="server" TargetControlID="pnlRoundSaveQuestionCategory"
                    Radius="6" Corners="All" />
                <asp:Panel ID="pnlSaveQuestionCategory" runat="server" Width="400px" CssClass="modalPopup">
                    <asp:Panel ID="pnlRoundSaveQuestionCategory" runat="server" Width="400px" CssClass="modalPopup2">
                        <br />
                        <div align="center" style="text-align: center; padding: 0px 10px 0px 10px; clear: both">
                            <table width="100%" border="0" cellpadding="5" cellspacing="5" style="border: solid 1px #5783BD">
                                <tr style="background-color: #5783BD;">
                                    <td style="padding: 5px; font-size: 20px; color: #ffffff; font-weight: bold">Save Question Category
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <asp:TextBox ID="txtCategoryName" runat="server" MaxLength="50" Width="250px"></asp:TextBox>
                                        ...
                                        <asp:HiddenField ID="hfQuestionCategoryID" runat="server" Value="0" />
                                        <asp:HiddenField ID="hfParentQuestionCategoryID" runat="server" Value="0" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                ...
                <div style="width: 90%; text-align: center; padding-left: 10px;">
                    ...
                    <br />
                    <div id="dvQuestionCategory" runat="server" align="center" style="width: 50%; clear: both">
                        <div align="left">
                        ...
                        <br />
                        <telerik:RadTreeList runat="server" ID="rtlQuestionCategory" AutoGenerateColumns="false" AllowPaging="true" PageSize="25" DataKeyNames="QuestionCategoryID" ParentDataKeyNames="ParentID" GridLines="None" OnNeedDataSource="rtlQuestionCategory_NeedDataSource" OnItemDataBound ="rtlQuestionCategory_ItemDataBound">
                            <Columns>
                                ...
                                <telerik:TreeListTemplateColumn HeaderStyle-Width="17%" ItemStyle-HorizontalAlign="Center" HeaderText="Add SubCategory" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true" UniqueName="AddSubCategory">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkAdd" runat="server" OnCommand="lnkAdd_Command" CommandArgument='<%# Eval("QuestionCategoryID")%>'><img src="../Images/icon-add.gif" alt="" style="border:none;" /></asp:LinkButton>
                                    </ItemTemplate>
                                </telerik:TreeListTemplateColumn>
                                <telerik:TreeListTemplateColumn HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%# Eval("QuestionCategoryID")%>'
                                            OnCommand="lnkEdit_Command"><img src="../Images/ic-edit.gif" alt="" style="border:none;" /></asp:LinkButton>
                                    </ItemTemplate>
                                </telerik:TreeListTemplateColumn>
                                <telerik:TreeListTemplateColumn HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkDelete" runat="server" OnCommand="lnkDelete_Command" CommandArgument='<%# Eval("QuestionCategoryID")%>' OnClientClick="return confirm('Are you sure you want to delete?')"><img src="../Images/icon-delete.gif" alt="" style="border:none;" /></asp:LinkButton>
                                    </ItemTemplate>
                                </telerik:TreeListTemplateColumn>
                            </Columns>
                        </telerik:RadTreeList>
