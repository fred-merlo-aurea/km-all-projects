<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true"
    CodeBehind="MarketPenetration.aspx.cs" Inherits="KMPS.MD.Main.MarketPenetration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <asp:HiddenField ID="hfSelectedFilterNo" runat="server" Value=""></asp:HiddenField>
            <asp:HiddenField ID="hfSelectedFilterOperation" runat="server" Value=""></asp:HiddenField>
            <asp:HiddenField ID="hfSuppressedFilterNo" runat="server" Value="" ></asp:HiddenField>
            <asp:HiddenField ID="hfSuppressedFilterOperation" runat="server" Value="" ></asp:HiddenField>
            ...
            <table border="0" cellpadding="5" cellspacing="3" width="100%" align="center">
                ...
                <tr>
                    ...
                    <td valign="top" align="left" width="15%">
                        <asp:ListBox ID="lstMarket" runat="server" Rows="10" DataValueField="MarketID" DataTextField="MarketName"
                            Style="text-transform: uppercase; width: 300px" SelectionMode="Multiple" Font-Size="x-small"
                    ...
                    <td width="75%" align="left">
                        ...
                        <asp:Button ID="btnSaveReport" runat="server" CssClass="button"
                            OnClick="btnSaveReport_Click" Text="Save Report" /><br /><br /> 
                                                    ...
                                                    <tr>
                                                        <td width="50%" align="center" valign="top">
                                                            <asp:GridView ID="grdSummary" SkinID="skingridAuto" runat="server" Width="75%" AutoGenerateColumns="false"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Markets" HeaderStyle-Width="6%" ItemStyle-Width="6%"
                                                                        ItemStyle-HorizontalAlign="center" ItemStyle-VerticalAlign="Top" FooterStyle-HorizontalAlign="center"
                                                                        FooterStyle-VerticalAlign="Top" HeaderStyle-HorizontalAlign="Center">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblMarkets" runat="server" Text='<%# Eval("key")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
