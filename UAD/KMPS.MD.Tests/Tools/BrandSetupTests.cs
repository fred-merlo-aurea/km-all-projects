...
namespace KMPS.MD.Tests.Tools
{
    ...
    public class BrandSetupTests : BasePageTests
    {
        ...
        private BrandSetup _testEntity;

        [SetUp]
        public override void SetUp()
        {
            base.SetUp();
            _testEntity = new BrandSetup();
        ...
        public void btnUpload_Click_FileNameIsInvalid_DisplaysError()
        {
            ...
            ShimBrandSetup.AllInstances.DisplayErrorString = (_, error) =>
            {
                hasError = true;
                errorMessage = error;
            };
