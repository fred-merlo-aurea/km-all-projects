...
namespace KMPS.MD.Tests.Main
{
    ...
    public class FilterSchedulesTests : BasePageTests
    {
        ...
        private FilterSchedules _testEntity = new FilterSchedules();
        ...
        public override void SetUp()
        {
            ...
            ShimFilterSchedules.AllInstances.ResetControls = (_) => { _resetControlsIsCalled = true; };
            ShimFilterSchedules.AllInstances.LoadGrid = (_) => { _loadGridIsCalled = true; };
            ShimFilterSchedules.AllInstances.LoadFilterSegmentationGrid = (_) => { _loadFilterSegmentationGridIsCalled = true; };
        ...
        public void rblListType_SelectedIndexChanged_ListTypeIsFilters_CallsLoadGrid()
        {
            ...
            ((Label)PrivatePage.GetField("lblSearch")).Text.ShouldBe("Filter Name");
