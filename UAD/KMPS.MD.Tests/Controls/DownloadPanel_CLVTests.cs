...
using DownloadPanel_CLV = KMPS.MD.Controls.DownloadPanel_CLV;

namespace KMPS.MD.Tests.Controls
{
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public partial class DownloadPanel_CLVTests : BaseControlTests
    {
        ...
        private DownloadPanel_CLV _testEntity;
        ...
        public void SubscriptionID_Set_GetSameValue()
        {
            // Arrange
            var value = new List<int> {1, 2};
            ShimSubscriber.GetUniqueLocationsCountClientConnectionsStringBuilder = (_, __) => 2;
