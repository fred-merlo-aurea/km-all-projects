...
using FiltersListPanel = KMPS.MD.Controls.FiltersListPanel;

namespace KMPS.MD.Tests.Controls
{
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public class FiltersListPanelTests : BaseControlTests
    {
        private FiltersListPanel _testEntity;

        [SetUp]
        public override void SetUp()
        {
            base.SetUp();
            _testEntity = new FiltersListPanel();
