...
{
    public partial class DownloadPanel_EVTests
    {
        ...
        private void SetupForDetailsDownload(int brandId, bool drpIsBillable)
        {
            ...
            ShimDownloadPanel_EV.AllInstances.saveDataCompareViewInt32NullableOfInt32Int32EnumsDataCompareTypeInt32 =
        ...
        private static void SetupShimsForSubscriber(string columnName)
        {
            ...
            ShimSubscriber
                    .GetProductDimensionSubscriberData_EVClientConnectionsStringBuilderListOfStringListOfInt32ListOfStringListOfStringListOfStringListOfStringInt32Boolean
                = (_, __, ___, ____, _____, ______, _______, ________, _________, __________) => dataTable;
            ShimSubscriber
                    .GetSubscriberData_EVClientConnectionsStringBuilderListOfStringListOfStringListOfStringListOfStringListOfStringInt32ListOfInt32BooleanBoolean
