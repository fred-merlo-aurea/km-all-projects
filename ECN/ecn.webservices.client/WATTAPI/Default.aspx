<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="_Default.aspx.cs" Inherits="ecn.webservices.client.WATTAPI._Default" %>
...
<body>
    ...
    <asp:Panel ID="pnlAddProfile" runat="server" Visible="true">
        <fieldset>
            <legend>UDF</legend>
            <table>
                <tr>
