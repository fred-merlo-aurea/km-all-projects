<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GetNextTokenForSubscriber.ascx.cs" Inherits="ecn.webservices.client.WATTAPI.GetNextTokenForSubscriber" %>
<table>
    <tr>
