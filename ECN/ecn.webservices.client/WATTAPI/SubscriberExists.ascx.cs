...
{
    public partial class SubscriberExists : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = wa.SubscriberExists(txtAccessKey.Text.Trim(), txtToken.Text.ToString(), Convert.ToInt32(txtIssueID.Text.Trim()));
