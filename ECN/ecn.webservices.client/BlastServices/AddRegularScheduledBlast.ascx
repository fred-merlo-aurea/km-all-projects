<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddRegularScheduledBlast.ascx.cs" Inherits="ecn.webservices.client.BlastServices.AddRegularScheduledBlast" %>
