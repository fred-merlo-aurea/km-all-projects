...
{
    public partial class GetBlastReport : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.GetBlastReport(txtAccessKey.Text.Trim(), Convert.ToInt32(txtBlast.Text.Trim()));
            }
            catch (Exception Ex)
            {
