<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GetBlastReportByISP.ascx.cs" Inherits="ecn.webservices.client.BlastServices.GetBlastReportByISP" %>
<table cellspacing="1" cellpadding="1" width="100%" align="center">
    ...
    <tr>
        <td align='right' class="label" valign="top" width="110">
            <asp:Label ID="lblSearch" runat="server" Text="Search XML:"></asp:Label>
        </td>
        <td align='left' class="label" valign="top" width="270">
            <asp:TextBox ID="txtSearch" runat="server" CssClass="formfield" Width="268"></asp:TextBox>
        </td>
    </tr>    
    <tr>
        <td>
