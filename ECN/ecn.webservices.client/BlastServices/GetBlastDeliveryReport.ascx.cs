...
{
    public partial class GetBlastDeliveryReport : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.GetBlastDeliveryReport(txtAccessKey.Text.Trim(), Convert.ToDateTime(txtFrom.Text.Trim()), Convert.ToDateTime(txtTo.Text.Trim()));
            }
            catch (Exception Ex)
            {
