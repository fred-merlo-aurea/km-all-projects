...
{
    public partial class GetBlastOpensReport : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.GetBlastOpensReport(txtAccessKey.Text.Trim(), Convert.ToInt32(txtBlast.Text.Trim()), txtFilter.Text.Trim(), Convert.ToBoolean(txtDetail.Text.Trim()));
            }
            catch (Exception Ex)
            {
