...
{
    public partial class GetBlastBounceReport : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.GetBlastBounceReport(txtAccessKey.Text.Trim(), Convert.ToInt32(txtBlast.Text.Trim()), Convert.ToBoolean(txtDetail.Text.Trim()));
            }
            catch (Exception Ex)
            {
