...
{
    public partial class GetBlastClicksReport : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.GetBlastClicksReport(txtAccessKey.Text.Trim(), Convert.ToInt32(txtBlast.Text.Trim()), txtFilter.Text.Trim(), Convert.ToBoolean(txtDetail.Text.Trim()));
            }
            catch (Exception Ex)
            {
