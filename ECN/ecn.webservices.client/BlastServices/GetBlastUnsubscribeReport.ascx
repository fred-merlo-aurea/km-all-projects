<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GetBlastUnsubscribeReport.ascx.cs" Inherits="ecn.webservices.client.BlastServices.GetBlastUnsubscribeReport" %>
