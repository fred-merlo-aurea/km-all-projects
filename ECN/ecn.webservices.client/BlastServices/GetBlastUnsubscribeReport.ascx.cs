...
{
    public partial class GetBlastUnsubscribeReport : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.GetBlastUnsubscribeReport(txtAccessKey.Text.Trim(), Convert.ToInt32(txtBlast.Text.Trim()), Convert.ToBoolean(txtDetail.Text.Trim()));
            }
            catch (Exception Ex)
            {
