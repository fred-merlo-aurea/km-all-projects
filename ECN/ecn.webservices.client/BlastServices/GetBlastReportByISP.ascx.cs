...
{
    public partial class GetBlastReportByISP : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.GetBlastReportByISP(txtAccessKey.Text.Trim(), Convert.ToInt32(txtBlast.Text.Trim()), txtSearch.Text.Trim());
            }
            catch (Exception Ex)
            {
