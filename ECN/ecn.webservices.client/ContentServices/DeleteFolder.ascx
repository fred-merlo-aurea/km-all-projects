<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeleteFolder.ascx.cs" Inherits="ecn.webservices.client.ContentServices.DeleteFolder" %>
<table cellspacing="1" cellpadding="1" width="100%" align="center">
    ...
    <tr>
        <td align='right' class="label" valign="top" width="110">
            <asp:Label ID="lblFolderID" runat="server" Text="Folder ID:"></asp:Label>
        </td>
        <td align='left' class="label" valign="top" width="270">
