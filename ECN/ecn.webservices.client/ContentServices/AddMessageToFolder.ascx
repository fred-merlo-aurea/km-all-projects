<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddMessageToFolder.ascx.cs" Inherits="ecn.webservices.client.ContentServices.AddMessageToFolder" %>
<table cellspacing="1" cellpadding="1" width="100%" align="center">
    <tr>
        ...
        <td align='center' class="label" valign="top" width="80" rowspan="17">
    ...
    <tr>
        <td align='right' class="label" valign="top" width="110">
            <asp:Label ID="lblMessageType" runat="server" Text="Message Type ID:"></asp:Label>
        </td>
        <td align='left' class="label" valign="top" width="270">
            <asp:TextBox ID="txtMessageType" runat="server" CssClass="formfield" Width="268"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td align='right' class="label" valign="top" width="110">
