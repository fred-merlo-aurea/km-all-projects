...
{
    public partial class DeleteContent : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.DeleteContent(txtAccessKey.Text.Trim(), Convert.ToInt32(txtContentID.Text.Trim()));
            }
            catch (Exception Ex)
            {
