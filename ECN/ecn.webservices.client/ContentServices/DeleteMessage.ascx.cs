...
{
    public partial class DeleteMessage : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.DeleteMessage(txtAccessKey.Text.Trim(), Convert.ToInt32(txtMessageID.Text.Trim()));
            }
            catch (Exception Ex)
            {
