...
{
    public partial class PreviewMessage : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.PreviewMessage(txtAccessKey.Text.Trim(), Convert.ToInt32(txtMessageID.Text.Trim()));
            }
            catch (Exception Ex)
            {
