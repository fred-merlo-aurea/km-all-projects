<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddContentToFolder.ascx.cs" Inherits="ecn.webservices.client.ContentServices.AddContentToFolder" %>
<table cellspacing="1" cellpadding="1" width="100%" align="center">
    ...
    <tr>
        <td align='right' class="label" valign="top" width="110">
            <asp:Label ID="lblWYSIWYG" runat="server" Text="UseWYSIWYGeditor:"></asp:Label>
        </td>
        <td align='left' class="label" valign="top" width="270">
            <asp:TextBox ID="txtWYSIWYG" runat="server" CssClass="formfield" Width="268"></asp:TextBox>
        </td>
    </tr>
    <tr>        
