<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GetLayout.ascx.cs" Inherits="ecn.webservices.client.ContentServices.GetLayout" %>
<table cellspacing="1" cellpadding="1" width="100%" align="center">
    ...
    <tr>
        <td align='right' class="label" valign="top" width="110">
            <asp:Label ID="lblLayoutID" runat="server" Text="Message ID:"></asp:Label>
        </td>
        <td align='left' class="label" valign="top" width="270">
            <asp:TextBox ID="txtLayoutID" runat="server" CssClass="formfield" Width="268"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
