...
{
    public partial class GetContentByFolderID : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.GetContentListByFolderID(txtAccessKey.Text.Trim(), Convert.ToInt32(txtFolderID.Text.Trim()));
            }
            catch (Exception Ex)
            {
