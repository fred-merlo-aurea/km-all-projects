<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpdateList.ascx.cs" Inherits="ecn.webservices.client.ListServices.UpdateList" %>
<table cellspacing="1" cellpadding="1" width="100%" align="center">
    ...
    <tr>
        <td align='right' class="label" valign="top" width="110">
            <asp:Label ID="lblListID" runat="server" Text="List ID:"></asp:Label>
        </td>
        <td align='left' class="label" valign="top" width="270">
            <asp:TextBox ID="txtListID" runat="server" CssClass="formfield" Width="268"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td align='right' class="label" valign="top" width="110">
            <asp:Label ID="lblList" runat="server" Text="New List Name:"></asp:Label>
        </td>
        <td align='left' class="label" valign="top" width="270">
    ...
    <tr>
        <td align='right' class="label" valign="top" width="110">
            <asp:Label ID="lblDescription" runat="server" Text="New List Desc:"></asp:Label>
        </td>
        <td align='left' class="label" valign="top" width="270">
    ...
    <tr>
        <td align='right' class="label" valign="top" width="110">
            <asp:Label ID="lblFolder" runat="server" Text="New Folder ID:"></asp:Label>
        </td>
        <td align='left' class="label" valign="top" width="270">
