...
{
    public partial class DeleteSubscriber : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.DeleteSubscriber(txtAccessKey.Text.Trim(), Convert.ToInt32(txtListID.Text.Trim()), txtEmailAddress.Text.Trim());
            }
            catch (Exception Ex)
            {
