<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddSubscribersGenerateUDF.ascx.cs" Inherits="ecn.webservices.client.ListServices.AddSubscribersGenerateUDF" %>
...
<table cellspacing="1" cellpadding="1" width="100%" align="center">
    ...
    <tr>
        <td align="right" class="label" valign="top" width="120">
            <asp:Label ID="lblAutoGenerateUDFs" runat="server" Text="Generate UDFs:"></asp:Label>
        </td>
        <td align="left" class="label" valign="top" width="270">
            <asp:TextBox ID="txtAutoGenerateUDFs" runat="server" CssClass="formfield" Width="268"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td align="right" class="label" valign="top" width="120">
        ...
        <td align="left" class="label" valign="top" width="270" rowspan="8">
            <asp:TextBox ID="txtXMLString" runat="server" TextMode="MultiLine" Width="268px"
                         Height="162px" style="margin-bottom: 0px">
            </asp:TextBox>
        </td>
    </tr>
    <tr>
