<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnsubscribeSubscriber.ascx.cs" Inherits="ecn.webservices.client.ListServices.UnsubscribeSubscriber" %>
<table cellspacing="1" cellpadding="1" width="100%" align="center">
    ...
    <tr>
        <td align='right' class="label" valign="top" width="110">
            <asp:Label ID="lblXMLEmails" runat="server" Text="XML Emails:"></asp:Label>
        </td>
        <td align='left' class="label" valign="top" width="270">
            <asp:TextBox ID="txtXMLEmails" runat="server" CssClass="formfield" Width="268"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
