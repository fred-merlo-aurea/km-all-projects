<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddSubscriberUsingSmartForm.ascx.cs" Inherits="ecn.webservices.client.ListServices.AddSubscriberUsingSmartForm" %>
