<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeleteSubscriber.ascx.cs" Inherits="ecn.webservices.client.ListServices.DeleteSubscriber" %>
<table cellspacing="1" cellpadding="1" width="100%" align="center">
    ...
    <tr>
        ...
        <td align='left' class="label" valign="top" width="270">
            <asp:TextBox ID="txtEmailAddress" runat="server" CssClass="formfield" Width="268"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
