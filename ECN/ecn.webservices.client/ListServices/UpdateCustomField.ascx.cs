...
{
    public partial class UpdateCustomField : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.UpdateCustomField(txtAccessKey.Text.Trim(), Convert.ToInt32(txtList.Text.Trim()), Convert.ToInt32(txtUDFID.Text.Trim()), txtField.Text.Trim(), txtDescription.Text.Trim(), txtPublic.Text.Trim());
            }
            catch (Exception Ex)
            {
