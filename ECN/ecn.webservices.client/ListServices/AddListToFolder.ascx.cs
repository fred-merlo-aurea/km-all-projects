...
{
    public partial class AddListToFolder : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    txtReturn.Text = ws.AddList(txtAccessKey.Text.Trim(), txtList.Text.Trim(), txtDescription.Text.Trim(), Convert.ToInt32(txtFolder.Text.Trim()));
                }
                else
                {
                    txtReturn.Text = ws.AddList(txtAccessKey.Text.Trim(), txtList.Text.Trim(), txtDescription.Text.Trim());
                }                
            }
            catch (Exception Ex)
            {
