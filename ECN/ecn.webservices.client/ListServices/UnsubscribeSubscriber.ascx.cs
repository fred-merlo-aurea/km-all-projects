...
{
    public partial class UnsubscribeSubscriber : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.UnsubscribeSubscriber(txtAccessKey.Text.Trim(), Convert.ToInt32(txtListID.Text.Trim()), txtXMLEmails.Text.Trim());
            }
            catch (Exception Ex)
            {
