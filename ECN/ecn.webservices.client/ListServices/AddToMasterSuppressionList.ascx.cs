...
{
    public partial class AddToMasterSuppressionList : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.AddToMasterSuppressionList(txtAccessKey.Text.Trim(), txtXMLString.Text);
            }
            catch (Exception Ex)
            {
