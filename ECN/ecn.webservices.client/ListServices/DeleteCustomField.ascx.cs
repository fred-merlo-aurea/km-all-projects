...
{
    public partial class DeleteCustomField : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtReturn.Text = ws.DeleteCustomField(txtAccessKey.Text.Trim(), Convert.ToInt32(txtListID.Text.Trim()), Convert.ToInt32(txtUDFID.Text.Trim()));
            }
            catch (Exception Ex)
            {
