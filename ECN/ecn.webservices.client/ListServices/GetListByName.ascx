<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GetListByName.ascx.cs" Inherits="ecn.webservices.client.ListServices.GetListByName" %>
<table cellspacing="1" cellpadding="1" width="100%" align="center">
    ...
    <tr>
        ...
        <td align='left' class="label" valign="top" width="270">
            <asp:TextBox ID="txtGroupName" runat="server" CssClass="formfield" Width="268"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
