...
namespace ecn.webservices.client.ContentManager_PROD {
    using System;
    ...
    public partial class ContentManager : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback AddMessage2OperationCompleted;
        ...
        public ContentManager() {
            this.Url = global::ecn.webservices.client.Properties.Settings.Default.ecn_webservices_client_ContentManager_PROD_ContentManager;
        ...
        /// <remarks/>
        public event AddMessage2CompletedEventHandler AddMessage2Completed;
        ...
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://webservices.ecn5.com/AddContentToFolderWithPreference", RequestElementName="AddContentToFolderWithPreference", RequestNamespace="http://webservices.ecn5.com/", ResponseElementName="AddContentToFolderWithPreferenceResponse", ResponseNamespace="http://webservices.ecn5.com/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute("AddContentToFolderWithPreferenceResult")]
        public string AddContent(string ecnAccessKey, string Title, string ContentHTML, string ContentText, int FolderID, bool UseWYSIWYGeditor) {
        ...
        /// <remarks/>
        public void AddContent2Async(string ecnAccessKey, string Title, string ContentHTML, string ContentText, int FolderID, bool UseWYSIWYGeditor) {
            this.AddContent2Async(ecnAccessKey, Title, ContentHTML, ContentText, FolderID, UseWYSIWYGeditor, null);
        }
        
        /// <remarks/>
        public void AddContent2Async(string ecnAccessKey, string Title, string ContentHTML, string ContentText, int FolderID, bool UseWYSIWYGeditor, object userState) {
            ...
            this.InvokeAsync("AddContent2", new object[] {
                        ...
                        ContentText,
                        FolderID,
                        UseWYSIWYGeditor}, this.AddContent2OperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.WebMethodAttribute(MessageName="AddMessage2")]
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://webservices.ecn5.com/AddMessageToFolderWithMessageType", RequestElementName="AddMessageToFolderWithMessageType", RequestNamespace="http://webservices.ecn5.com/", ResponseElementName="AddMessageToFolderWithMessageTypeResponse", ResponseNamespace="http://webservices.ecn5.com/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute("AddMessageToFolderWithMessageTypeResult")]
        public string AddMessage(
                    string ecnAccessKey, 
                    string LayoutName, 
                    int MessageTypeID, 
                    ...
                    int Content7, 
                    int Content8) {
            object[] results = this.Invoke("AddMessage2", new object[] {
                        ecnAccessKey,
                        LayoutName,
                        MessageTypeID,
                        FolderID,
        ...
        public void AddMessage2Async(
                    ...
                    int Content7, 
                    int Content8) {
            this.AddMessage2Async(ecnAccessKey, LayoutName, MessageTypeID, FolderID, TableBorder, TemplateID, Address, DeptID, Content0, Content1, Content2, Content3, Content4, Content5, Content6, Content7, Content8, null);
        }
        ...
        public void AddMessage2Async(
                    ...
                    int Content8, 
                    object userState) {
            if ((this.AddMessage2OperationCompleted == null)) {
                this.AddMessage2OperationCompleted = new System.Threading.SendOrPostCallback(this.OnAddMessage2OperationCompleted);
            }
            this.InvokeAsync("AddMessage2", new object[] {
                        ecnAccessKey,
                        LayoutName,
                        MessageTypeID,
                        FolderID,
                        ...
                        Content6,
                        Content7,
                        Content8}, this.AddMessage2OperationCompleted, userState);
        }
        
        private void OnAddMessage2OperationCompleted(object arg) {
            if ((this.AddMessage2Completed != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.AddMessage2Completed(this, new AddMessage2CompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1038.0")]
    public delegate void AddMessage2CompletedEventHandler(object sender, AddMessage2CompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1038.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class AddMessage2CompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal AddMessage2CompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
