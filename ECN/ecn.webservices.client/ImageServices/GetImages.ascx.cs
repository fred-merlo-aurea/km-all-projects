...
{
    public partial class GetImages : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    txtReturn.Text = ws.GetImages(txtAccessKey.Text.Trim(), txtFolder.Text.Trim());
                }
                else
                {
                    txtReturn.Text = ws.GetImages(txtAccessKey.Text.Trim());
                }
            }
            catch (Exception Ex)
            {
