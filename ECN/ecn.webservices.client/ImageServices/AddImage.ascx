<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddImage.ascx.cs" Inherits="ecn.webservices.client.ImageServices.AddImage" %>
<table cellspacing="1" cellpadding="1" width="100%" align="center">
    ...
    <tr>
        ...
        <td align='left' class="label" valign="top" width="270">
            <asp:TextBox ID="txtImage" runat="server" CssClass="formfield" Width="268" 
                Enabled="False">Disabled</asp:TextBox>
            For test this uses a static file on the server.</td>
    </tr>
    <tr>
        <td align='right' class="label" valign="top" width="110">
        ...
        <td align='left' class="label" valign="top" width="270">
            <asp:TextBox ID="txtImageName" runat="server" CssClass="formfield" Width="268"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td align='right' class="label" valign="top" width="110">
