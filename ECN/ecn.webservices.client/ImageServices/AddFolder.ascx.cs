    ...
    public partial class AddFolder : System.Web.UI.UserControl
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    txtReturn.Text = ws.AddFolder(txtAccessKey.Text.Trim(), txtFolder.Text.Trim(), txtParentFolder.Text.Trim());
                }
                else
                {
                    txtReturn.Text = ws.AddFolder(txtAccessKey.Text.Trim(), txtFolder.Text.Trim());
                }
            }
            catch (Exception Ex)
            {
