<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GetFolders.ascx.cs" Inherits="ecn.webservices.client.ImageServices.GetFolders" %>
<table cellspacing="1" cellpadding="1" width="100%" align="center">
    ...
    <tr>
        <td align='right' class="label" valign="top" width="110">
            <asp:Label ID="lblParentFolder" runat="server" Text="Parent Folder Name:"></asp:Label>
        </td>
        <td align='left' class="label" valign="top" width="270">
