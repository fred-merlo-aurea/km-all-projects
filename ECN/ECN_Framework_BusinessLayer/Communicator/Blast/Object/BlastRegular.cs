...
{
    public class BlastRegular : BlastExtendedAbstract
    {
        ...
        public static ECN_Framework_Common.Objects.Enums.Entity Entity = ECN_Framework_Common.Objects.Enums.Entity.BlastRegular;

        public override BlastType BlastType
        {
            get
            {
                return BlastType.HTML;
            }
        }
        ...
        public override void Validate(ECN_Framework_Entities.Communicator.BlastAbstract blast, KMPlatform.Entity.User user)
        {
            ...
            if (blast.StatusCode != ECN_Framework_Common.Objects.Communicator.Enums.BlastStatusCode.Pending.ToString() && blast.StatusCode != ECN_Framework_Common.Objects.Communicator.Enums.BlastStatusCode.Paused.ToString())
