<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Click.aspx.cs" Inherits="ecn.activityengines.Click" %>
		...
		<asp:panel id="mailSenderFormPanel" runat="Server" visible=false>
			<form id=mailSenderForm name=mailSenderForm>
				<table width=50% align="center" border='0' cellpadding="5">
					<tr>
						<td align='right' class="tableHeader">To :</td><td style="font-family:arial; font-size:12px">&nbsp;<%= Link.Replace("mailto:", "")%></td>
					</tr>
					<tr>
					...
					<tr>
						<td align="center" style="font-family:arial; font-size:12px" class="tableHeader" colspan=2><input type=button name="sendButton" value="Create Email" class=formfield onclick="sendEmailNow('<%= Link.Replace("mailto:","") %>')"></td>
					</tr>												
				</table>
			</form>
		</asp:panel>
