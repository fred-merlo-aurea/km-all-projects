...
namespace KMPlatform.DataAccess
{
    public class Profile
    {
        ...
        public static List<Entity.Profile> Search(string searchValue, string searchFields, string orderBy)
        {
        ...
        public static Entity.Profile Select(int profileID)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static List<Entity.Profile> SelectPublisher(int publisherID)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static List<Entity.Profile> SelectProspect(int publicationID)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static List<Entity.Profile> SelectPublicationSubscribed(int publicationID, bool isSubscribed)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static List<Entity.Profile> SelectPublicationProspect(int publicationID, bool isProspect)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static List<Entity.Profile> SelectPublication(int publicationID, bool isSubscribed, bool isProspect)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static List<Entity.Profile> SelectPublication(int publicationID)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                using (SqlDataReader rdr = KM.Common.DataFunctions.ExecuteReader(cmd, ConnectionString.KMPlatform.ToString()))
                {
                    if (rdr != null)
                    {
                        ...
                        var builder = DynamicBuilder<Entity.Profile>.CreateBuilder(rdr);
                        while (rdr.Read())
                        {
        ...
        public static int Save(Entity.Profile x)
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@Address3", x.Address3));
            ...
            cmd.Parameters.Add(new SqlParameter("@PhoneExists", x.PhoneExists));
            cmd.Parameters.Add(new SqlParameter("@Mobile", x.Mobile));
            cmd.Parameters.Add(new SqlParameter("@MobileExists", x.MobileExists));
            cmd.Parameters.Add(new SqlParameter("@Fax", x.Fax));
            cmd.Parameters.Add(new SqlParameter("@FaxExists", x.FaxExists));
            cmd.Parameters.Add(new SqlParameter("@Email", x.Email));
            cmd.Parameters.Add(new SqlParameter("@EmailExists", x.EmailExists));
