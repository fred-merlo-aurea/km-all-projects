...
Begin
	select @ClientGroupServiceFeatureMapID = ClientGroupServiceFeatureMapID from ClientGroupServiceFeatureMap where ClientGroupID = @ClientGroupID and ServiceFeatureID = @ServiceFeatureID
End
