CREATE PROCEDURE [dbo].[sp_SSB_ProcessEmailAction_BlastActivityRefer]    
	@message_body XML
...
Descr:		Create SP to parse new Email Refer data into BlastActivityRefer table and update BlastSummary table
...
DECLARE @tempActivity table(
	...
	WITH (EAID int,
		...
		Processed char(10),
		BlastLinkID int) a 
	WHERE a.ActionTypeCode IN ('Refer')
