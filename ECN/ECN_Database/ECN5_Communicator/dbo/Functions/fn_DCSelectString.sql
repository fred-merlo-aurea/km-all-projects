CREATE FUNCTION [dbo].[fn_DCSelectString](@layoutID int)   
...
BEGIN       
	...
	set @selectslotstr = 'select %slot1% as slot1, %slot2% as slot2,%slot3% as slot3, %slot4% as slot4, %slot5% as slot5, %slot6% as slot6, %slot7% as slot7, %slot8% as slot8, %slot9% as slot9, inn2.*  ' 
