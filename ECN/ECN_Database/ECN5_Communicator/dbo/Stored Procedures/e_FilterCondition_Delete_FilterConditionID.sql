CREATE  PROC [dbo].[e_FilterCondition_Delete_FilterConditionID] 
(
	@CustomerID int = NULL,
...
BEGIN
	...
	WHERE f.CustomerID = @CustomerID AND fc.FilterGroupID = @FilterGroupID AND fc.FilterConditionID = @FilterConditionID
END
