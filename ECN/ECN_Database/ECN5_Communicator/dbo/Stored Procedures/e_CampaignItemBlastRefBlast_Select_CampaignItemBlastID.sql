CREATE PROCEDURE [dbo].[e_CampaignItemBlastRefBlast_Select_CampaignItemBlastID]   
...
AS
    ...
    WHERE cibrb.CampaignItemBlastID = @CampaignItemBlastID and cibrb.IsDeleted = 0 and cib.IsDeleted = 0 and ci.IsDeleted = 0 and c.IsDeleted = 0