CREATE  PROC [dbo].[e_CampaignItemBlast_Delete_Single] 
(
	@CustomerID int,
    @CampaignItemID int,
...
BEGIN
	...
	WHERE cib.CampaignItemID = @CampaignItemID AND c.CustomerID = @CustomerID and cib.CampaignItemBlastID = @CampaignItemBlastID
END