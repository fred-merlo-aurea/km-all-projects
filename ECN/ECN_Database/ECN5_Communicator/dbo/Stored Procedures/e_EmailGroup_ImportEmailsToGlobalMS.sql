CREATE proc [dbo].[e_EmailGroup_ImportEmailsToGlobalMS]
(  
 @xml text,
 @UserID int
)  
...
Begin  
	...
	update #emails
	set alreadyexists = 1
	from #emails e join GlobalMasterSuppressionList gms on e.emailaddress = gms.emailaddress 
	where gms.IsDeleted = 0
	...
	insert into GlobalMasterSuppressionList (Emailaddress, CreatedDate, CreatedUserID, IsDeleted)  
	SELECT el.EmailAddress, @dt, @UserID, 0
	from #emails el
