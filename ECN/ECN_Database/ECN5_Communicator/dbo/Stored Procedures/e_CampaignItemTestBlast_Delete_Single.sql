CREATE  PROC [dbo].[e_CampaignItemTestBlast_Delete_Single] 
(
	@CustomerID int,
    @CampaignItemID int,
...
BEGIN
	...
	WHERE citb.CampaignItemID = @CampaignItemID AND c.CustomerID = @CustomerID and citb.CampaignItemTestBlastID = @CampaignItemTestBlastID
END