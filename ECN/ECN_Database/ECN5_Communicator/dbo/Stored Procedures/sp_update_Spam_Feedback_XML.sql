CREATE Procedure [dbo].[sp_update_Spam_Feedback_XML] (
	@xmlDocument Text ,
 @ActionTypeCode varchar(100)
)  
as 

INSERT INTO ECN_ACTIVITY..OldProcsInUse (ProcName, DateUsed) VALUES ('sp_update_Spam_Feedback_XML', GETDATE())
...
insert into @e (emailID, blastID, ActionNotes)  
SELECT * FROM OPENXML(@docHandle, N'/ROOT/BOUNCE') WITH (EmailID INT '@EmailID', BlastID INT '@BlastID', DataValue varchar(255) '@Comments')  
...
EXEC sp_xml_removedocument @docHandle
 ...
 select  distinct  e1.EmailID, e1.BlastID, @ActionTypeCode, getdate(), 'U', e1.ActionNotes, 'n'    
 from  @e e1 
