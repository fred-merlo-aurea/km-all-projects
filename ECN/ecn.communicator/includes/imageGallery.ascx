...
<%@ Control Language="c#" Inherits="ecn.communicator.includes.imageGallery" CodeBehind="imageGallery.ascx.cs" %>
...
<script language='JavaScript'>
    function ConfirmDelete() {
        if (confirm("Are you sure?\nAll selected Images will be deleted permanently.") == true)
            return true;
        else
            return false;
    }
                                ...
                                <table cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td valign="bottom" width="118">
                                            <h3 class="blackBtn">
                                                <asp:LinkButton ID="tabBrowse" Style="padding-right: 0px; padding-left: 20px; padding-bottom: 0px; cursor: pointer; padding-top: 0px"
                                                    OnClick="showBrowse" Text="" runat="server">
													<span>Browse Images</span></asp:LinkButton></h3>
                                        </td>
                                        <asp:Panel ID="tabUploadImagesPanel" runat="server">
                                            <td valign="top" align="right" width="15">
                                                <img style="left: 25px; position: relative; top: 4px" src="/ecn.images/images/upload_img.gif"
                                                    border="0"></td>
                                            <td valign="bottom" width="115">
                                                <h3 class="blackBtn">
                                                    <asp:LinkButton ID="tabUpload" Style="padding-right: 0px; padding-left: 20px; padding-bottom: 0px; cursor: pointer; padding-top: 0px"
                                                        OnClick="showUpload" Text="" runat="server">
                                        ...
                                        <asp:Panel ID="tabDeleteImagesPanel" Style="display: inline" runat="server">
                                            ...
                                            <td valign="top" width="115">
                                                <h3 class="blackBtn">
                                                    <asp:LinkButton ID="tabDeleteImages" Style="padding-right: 0px; padding-left: 20px; padding-bottom: 0px; cursor: pointer; padding-top: 0px"
                                        ...
                                        <td style="padding-right: 5px" align="right" colspan="3">
                                            <asp:DataGrid ID="ImageListGrid" runat="server" CssClass="gridWizard" OnSortCommand="ImageList_Sort"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn>
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="DGChkBxImages" runat="server"></asp:CheckBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                    ...
                                    <tr>
                                        <td style="padding-right: 5px" align="right" colspan="3">
                                            <asp:DataList ID="ImageListRepeater" runat="server" BorderWidth="0" RepeatLayout="Table"
                                                ...
                                                <ItemTemplate>
                                                    <table class="tableContent" align="center" cellpadding="0" style="width: 175px; height: 171px;">
                                                        <tr>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                        <tr>
                                                                            <td height="110" width="175" align="center" colspan="2">
                                                                                ...
                                                                                <asp:ImageButton runat="server" ID="BrowseImage" ImageUrl='<%#DataBinder.Eval(Container.DataItem,"Image")%>'></asp:ImageButton>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                ...
                                <table cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td valign="top" width="118">
                                            <h3 class="blackBtn">
                                                <asp:LinkButton ID="tabBrowseBottom" Style="padding-right: 0px; padding-left: 20px; padding-bottom: 0px; cursor: pointer; padding-top: 0px"
                                                    OnClick="showBrowse"
                                                    Text="" runat="server">
													<span>Browse Images</span></asp:LinkButton></h3>
                                        </td>
                                        <asp:Panel ID="pnlUploadImagesBottom" runat="server" >
                                        <td valign="top" align="right" width="15">
                                            <img style="left: 25px; position: relative; top: 4px" src="/ecn.images/images/upload_img.gif"
                                                border="0"></td>
                                        <td valign="top" width="115">
                                            <h3 class="blackBtn">
                                                <asp:LinkButton ID="tabUploadBottom" Style="padding-right: 0px; padding-left: 20px; padding-bottom: 0px; cursor: pointer; padding-top: 0px"
                                                    OnClick="showUpload"
                                                    Text="" runat="server">
													<span>Upload Images</span></asp:LinkButton></h3>
                                        </td>
                                        ...
                                        <asp:Panel ID="tabDeleteImagesPanelBottom" Style="display: inline" runat="server">
                                            ...
                                            <td valign="top" width="115">
                                                <h3 class="blackBtn">
                                                    <asp:LinkButton ID="tabDeleteImagesBottom" Style="padding-right: 0px; padding-left: 20px; padding-bottom: 0px; cursor: pointer; padding-top: 0px"
                                                        OnClick="deleteSelectedImages"
                                                        Text="" runat="server">
														<span>Delete Images</span></asp:LinkButton></h3>
                                            </td>
