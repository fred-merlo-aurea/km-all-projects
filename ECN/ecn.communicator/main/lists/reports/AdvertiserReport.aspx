<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdvertiserReport.aspx.cs"
    Inherits="ecn.communicator.main.lists.reports.AdvertiserReport" MasterPageFile="~/MasterPages/Communicator.Master" %>
                                ...
                                <td class="offWhite borderSides" valign="top" colspan="2" align="left">
                                    <table cellspacing="2" cellpadding="5" border='0' width="100%" class="formLabel"
                                        ...
                                        <tr>
                                            <td align='right'></td>
                                            <td>
                                                <asp:label id="StatsHistoryMsg" runat="server"></asp:label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%" align='right'>
