...
{
    public partial class content_mainMsg : ECN_Framework.WebPageHelper
    {
        protected void Page_Load(object sender, System.EventArgs e)
        {
            Master.CurrentMenuCode = ECN_Framework_Common.Objects.Communicator.Enums.MenuCode.CONTENT;
            Master.SubMenu = "message list";
            Master.Heading = "Content/Messages > Manage Messages";
            ...
            if (!Page.IsPostBack)
            {
                layoutExplorer1.enableEditMode();
