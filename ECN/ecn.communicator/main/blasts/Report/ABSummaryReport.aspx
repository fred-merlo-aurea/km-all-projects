<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABSummaryReport.aspx.cs" Inherits="ecn.communicator.main.blasts.Report.ABSummaryReport" MasterPageFile="~/MasterPages/Communicator.Master" %>
        ...
        <tr>
            <td>
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr class="gradient">
                        <td width="50%" valign="middle" style="border-right: medium none; padding-right: 5px; border-top: #a4a2a3 1px solid; padding-left: 5px; padding-bottom: 0px; font: bold 13px Arial, Helvetica, sans-serif; border-left: #a4a2a3 1px solid; color: #333; padding-top: 0px; border-bottom: #a4a2a3 1px solid">&nbsp;A/B Summary Report
                        </td>
