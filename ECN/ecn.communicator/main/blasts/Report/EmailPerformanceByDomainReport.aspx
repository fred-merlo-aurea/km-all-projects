<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Communicator.Master" AutoEventWireup="true" CodeBehind="EmailPerformanceByDomainReport.aspx.cs" Inherits="ecn.communicator.main.blasts.Report.EmailsPerformanceByDomainReport" %>
        ...
        <tr>
            <td>
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr class="gradient">
                        <td width="50%" valign="middle" style="border-right: medium none; padding-right: 5px; border-top: #a4a2a3 1px solid; padding-left: 5px; padding-bottom: 0px; font: bold 13px Arial, Helvetica, sans-serif; border-left: #a4a2a3 1px solid; color: #333; padding-top: 0px; border-bottom: #a4a2a3 1px solid">&nbsp;Email Performance By Domain 
                        </td>
                            ...
                            <table cellspacing="2" cellpadding="5" border='0' width="100%" class="formLabel"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:left;">
                                        <asp:CheckBox ID="chkDrillDownOther" runat="server" Text="Breakdown Details of 'Other' Domain (Top 50)" AutoPostBack="false" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td class="offWhite borderSides" colspan="2" align="center">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="100%" ShowRefreshButton="false" ShowZoomControl="false" ShowPrintButton="False" ShowExportControls="False">
                            </rsweb:ReportViewer>
                            &nbsp;
                        </td>
                    </tr>
