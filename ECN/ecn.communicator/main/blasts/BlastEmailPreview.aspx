<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BlastEmailPreview.aspx.cs"
    Inherits="ecn.communicator.main.blasts.BlastEmailPreview" %>
        ...
        <asp:UpdatePanel ID="updateBEP" runat="server">
            <ContentTemplate>
                <table cellpadding="2" cellspacing="2" border="0" width="100%">
                    <tr>
                        <td>
                            <asp:Label ID="lblPublicURL" runat="server" CssClass="label" Text=""
