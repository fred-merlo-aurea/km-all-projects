<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GroupStatisticsSettings.ascx.cs" Inherits="ecn.communicator.main.Reports.ReportSettingsControls.GroupStatisticsSettings" %>
...
<asp:UpdatePanel ID="upMain" runat="server">
    <ContentTemplate>
        <table>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label2" runat="server" Text="Show Browser Details" CssClass="label"></asp:Label></td>
                <td>
                    <asp:DropDownList ID="drpShowBroswerDetails" runat="server">
