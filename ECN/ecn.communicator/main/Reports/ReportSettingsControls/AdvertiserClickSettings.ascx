<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdvertiserClickSettings.ascx.cs" Inherits="ecn.communicator.main.Reports.ReportSettingsControls.AdvertiserClickSettings" %>
