<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Communicator.Master" AutoEventWireup="true" CodeBehind="OmnitureBaseChannelSetup.aspx.cs" Inherits="ecn.communicator.main.Omniture.OmnitureBaseChannelSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel runat="server" ID="pnlContent">
        <table style="width: 100%;">
            ...
            <tr>
                <td style="text-align: left;">
                    <asp:Label ID="lblTitle" Text="OMNITURE TRACKING BASE CHANNEL SETUP" runat="server" Font-Bold="true" Font-Size="Medium" />
                </td>
            </tr>
            <tr>
                <td style="text-align: left;">
                    <table style="margin-left: 20px; margin-top: 20px; width: 100%;">
                        <tr>
                            <td></td>
                            <td>
                                <asp:CheckBox ID="chkboxOverride" Text="Allow Customer Override" runat="server" Checked="false" />
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 15%;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ajaxToolkit:FilteredTextBoxExtender ID="ftbeDelimiter" runat="server" FilterType="Custom" FilterMode="InvalidChars" InvalidChars="/?&#\^=" TargetControlID="txtDelimiter" />
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <table style="background-color: white;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ajaxToolkit:FilteredTextBoxExtender ID="ftbeOmniParamOption" runat="server" TargetControlID="txtOmniParamOption" FilterMode="InvalidChars" FilterType="Custom" InvalidChars="/%&#\^!@*$?<>{}|+=-_~" />
                            &nbsp;&nbsp;
                                ...
                                <ecnCustom:ecnGridView ID="gvOmniParamOptions" runat="server" AllowSorting="false" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="Field Names" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DisplayName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
        ...
        <ajaxToolkit:ModalPopupExtender ID="mpeTemplateNotif" runat="server" BackgroundCssClass="modalBackground"
            PopupControlID="upTemplateNotif" TargetControlID="hfTemplateNotif"  CancelControlID="btnCancelTemplate" />
