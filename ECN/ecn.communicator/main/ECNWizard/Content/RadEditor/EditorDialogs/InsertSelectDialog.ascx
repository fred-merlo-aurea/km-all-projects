...
<style type="text/css">
	...
	.RadForm_Bootstrap .reInsertSelectCssClass {
		width: 230px;
		height: 315px;
	}

	.RadForm_Material .reInsertSelectCssClass {
		width: 250px;
	}

	.RadForm_Silk .reInsertSelectCssClass,
	.RadForm_GLow .reInsertSelectCssClass {
		height: 280px;
	}
	...
	.reLightweightDialog .reInsertSelectDialogTable .reInsertSelectItemsWrapper {
		padding: 5px;
	}
	
	.RadForm_BlackMetroTouch .reInsertSelectItemsWrapper,
	.RadForm_MetroTouch .reInsertSelectItemsWrapper,
	.RadForm_Material .reInsertSelectItemsWrapper {
		height: 315px;
	}

	.RadForm_Silk .reInsertSelectItemsWrapper,
	.RadForm_Glow .reInsertSelectItemsWrapper {
		height: 280px;
	}
	...
	.RadForm_Bootstrap .redDimensionPixels {
		...
		<tr>
			<td>
				<fieldset class="reInsertSelectItemsWrapper">
					...
					<div class="reInsertSelectButtonsWrapper reInsertSelectSpinBoxWrapper">
