...
/*.reLightweightDialog .reSpinBox {
		width: 53px;
	}*/
.reLightweightDialog .reSpinBox.reSpinBoxHiddenInput {
	width: auto;
}

.reLightweightDialog.RadForm_MetroTouch .reSpinBoxHiddenInput,
.reLightweightDialog.RadForm_BlackMetroTouch .reSpinBoxHiddenInput {
	width: 5em;
}
.reLightweightDialog.RadForm_MetroTouch .reTableWizardColumns .propertyLabel.first,
.reLightweightDialog.RadForm_BlackMetroTouch .reTableWizardColumns .propertyLabel.first {
	margin-left: -8px !important;
	margin-right: -14px;
}
.reLightweightDialog.RadForm_MetroTouch .reTableWizardColumns .propertyLabel.second,
.reLightweightDialog.RadForm_BlackMetroTouch .reTableWizardColumns .propertyLabel.second {
	margin-left: 20px !important;
}

.reLightweightDialog.RadForm_MetroTouch .reTableWizardColumns,
.reLightweightDialog.RadForm_BlackMetroTouch .reTableWizardColumns {
	padding: 20px;
}
	.reLightweightDialog.RadForm_MetroTouch .reTableWizardColumns td,
	.reLightweightDialog.RadForm_BlackMetroTouch .reTableWizardColumns td {
		margin-left: 5px;
		margin-right: 5px;
	}

	.reLightweightDialog  .reInsertSelectSpinBoxWrapper .reSpinBox {
		width: 80px;
	}
