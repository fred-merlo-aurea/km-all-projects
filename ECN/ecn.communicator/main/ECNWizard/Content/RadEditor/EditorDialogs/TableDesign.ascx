					...
					<td>
						<fieldset style="width: 378px; height: 44px;" class="reTableWizardColumns">
							...
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td>
										<div class="propertyLabel first" style="width: 80px; text-align: left; margin-left: 8px; margin-bottom: 6px;">
											<script type="text/javascript">									                                                                                                            	document.write(localization["Columns"]);</script>
											:</div>
									</td>
									<td>
										<span class="reInsertSelectSpinBoxWrapper">
										<tools:EditorSpinBox ID="SpinBoxColumns" VisibleInput="false" runat="server" />
										</span>
									</td>
									<td>
										<div class="propertyLabel second" style="width: 100px; text-align: left; margin-left: 40px; margin-bottom: 6px;">
		...
		<td>
			<fieldset style="width: 302px; height: 394px;" class="reTableWizardRows">
				...
				<table border="0" cellpadding="0" cellspacing="0" style="margin: 40px 0 0 6px;">
					...
					<tr>
						<td>
							<div class="propertyLabel" style="text-align: left; margin-left: 6px; width: 75px;">
