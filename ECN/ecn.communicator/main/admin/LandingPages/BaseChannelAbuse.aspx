<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Communicator.Master" AutoEventWireup="true" CodeBehind="BaseChannelAbuse.aspx.cs" Inherits="ecn.communicator.main.admin.LandingPages.BaseChannelAbuse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <asp:Panel runat="server" ID="pnlNoAccess">
             ...
             <asp:Panel runat="server" ID="pnlSettings">
                ...
                <table style="width:100%;">
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="lblHeading" runat="server" Text="Report Abuse Page Settings" Font-Bold="true" Font-Size="Medium"></asp:Label>
                            <br />
                            <br />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <table style="width:100%;">
                                <tr>
                                    <td>
                                        <asp:Label ID="lblThankYou" runat="server" Text="Thank You Message" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtThankYou" runat="server" TextMode="MultiLine" CssClass="styled-text-multiline" onkeyup="disableButton()" Width="100%" />
                                    </td>
                                </tr>
                            </table>
                        </td>
    ...
    <asp:Button ID="hfShowPopup" runat="server" style="display:none;" />
    <ajaxToolkit:ModalPopupExtender ID="modalPopupHtmlPreview" runat="server" BackgroundCssClass="modalBackground"
        PopupControlID="pnlHtmlPreview" TargetControlID="hfShowPopup">
