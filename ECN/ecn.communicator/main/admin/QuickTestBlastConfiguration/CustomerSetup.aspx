<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Communicator.Master" AutoEventWireup="true" CodeBehind="CustomerSetup.aspx.cs" Inherits="ecn.communicator.main.admin.QuickTestBlastConfiguration.CustomerSetup" %>
                    ...
                    <tr>
                        <td>
                            <table style="width:100%;margin-bottom: 30px;">
                                <tr>
                                    <td colspan="2">
                                        <asp:Label ID="lblHeading" runat="server" Text="Blast Configuration Customer Setup" Font-Bold="true" Font-Size="Medium"></asp:Label>
                                        <br />
                                        <br />
                                    </td>
                                </tr>
