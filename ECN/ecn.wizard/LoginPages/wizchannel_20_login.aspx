<%@ Page language="c#" Codebehind="wizchannel_20_login.aspx.cs" AutoEventWireup="True" Inherits="ecn.wizard.LoginPages.wizchannel_20_login" %>
	...
	<body>
		<center>
			<form action="../LoginHandlers/DirectLogin.aspx" method="post" class="body_bg">
				<INPUT id="channelID" type="hidden" name="channelID" value="20">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td width="100%">
							<img border="0" src="../images/uw_header.jpg"></td>
					</tr>
				</table>
				<br>
				<br>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="94%" align="center"><tr><td width="100%"><img src="../images/uw_footer.jpg" border="0" usemap="#Map"></td>
				</tr></table>
			</form>
		</center>
	    <map name="Map" id="Map">
          <area shape="rect" coords="364,38,445,53" href="http://toolbox.unityworksmedia.com/Login/tabid/36/ctl/Terms/Default.aspx" target="_blank" />
          <area shape="rect" coords="455,38,557,53" href="http://toolbox.unityworksmedia.com/Login/tabid/36/ctl/Privacy/Default.aspx" target="_blank" />
          <area shape="rect" coords="565,38,719,53" href="http://www.unityworksmedia.com" target="_blank" />
	    </map>
	</body>
</HTML>
