...
namespace ecn.wizard.InvokeWSHandlers {
	/// <summary>
	/// Summary description for WebForm1.
	/// </summary>
	public partial class InvokeWS : System.Web.UI.Page {
		protected void Page_Load(object sender, System.EventArgs e) {
			// Create AccountCreation Object
			//AccountCreation ac = new AccountCreation();
			int newCustomerID = 1316;
			int newUserID = 1398;
			int groupID = 4061;
			...
			if(accessKey.Length > 0){
				Response.Redirect(login.getAutoLoginURL()+accessKey+"&groupID="+groupID,true);
			}
