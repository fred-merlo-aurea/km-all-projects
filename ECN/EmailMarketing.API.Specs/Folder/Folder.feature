Feature: Folder
	...
	I want to CRUD (Create, Read, Update, Delete) Folder
...
Scenario: GET an existing resource
	...
	And I have an existing Folder ID of 111
	When I invoke GET
	Then I should receive an HTTP Response
	And status should be "200 OK"
	And The HTTP Response Content should be a valid Folder Object
	And The API Model object should have a FolderID property matching the given Folder ID

@Folder_API
Scenario: PUT an update to an existing resource
	Given I have a valid API Access Key of "8CAB09B9-BEC9-453F-A689-E85D5C9E4898"
	And I have a Customer ID of 1
	And I have an existing Folder Object with a FolderID of 111
	And I generate a RandomString to append to the FolderDescription
	When I invoke PUT
	Then I should receive an HTTP Response
	And status should be "200 OK"
	And a Location Header should be sent
	And the Location Header should end with FolderID
	And HttpResponseContent should have FolderDescription ending with the RandomString

@Folder_API
Scenario: POST a new resource
   Given I have a valid API Access Key of "8CAB09B9-BEC9-453F-A689-E85D5C9E4898"
	And I have a Customer ID of 1
	 And I have a new Folder Object
	When I invoke POST
	Then I should receive an HTTP Response
	 ...
	 And the Location Header should end with FolderID
	 And HttpResponseContent should have FolderDescription ending with the RandomString
	 And I can store the Folder object to test delete

@Folder_API
Scenario: DELETE a resource
   Given I have a valid API Access Key of "8CAB09B9-BEC9-453F-A689-E85D5C9E4898"
	 And I have a Customer ID of 1
	 And I have a deletable Folder Object
...
Scenario: GET when missing API Access Key
   Given I have an existing Folder ID of 111
	 And I have a Customer ID of 1
	When I invoke GET
	Then I should receive an HTTP Response
...
@Folder_API
Scenario: GET non-existent Folder
   Given I have a valid API Access Key of "8CAB09B9-BEC9-453F-A689-E85D5C9E4898"
	 And I have a Customer ID of 1
     And I have an nonexistent Folder ID of 12345
	When I invoke GET
	Then I should receive an HTTP Response
...
Scenario: PUT invalid data
	Given I have a valid API Access Key of "8CAB09B9-BEC9-453F-A689-E85D5C9E4898"
	 And I have a Customer ID of 1
	And I have an existing Folder Object with a FolderID of 111
	And I append invalid character '"' to the FolderName
	When I invoke PUT
	Then I should receive an HTTP Response
	 And status should be "400 Bad Request"
	 And the HTTP Response Content should be an HttpError
	 And the error Message Should be 'entity: folder method: validate message: foldername has invalid characters. '
