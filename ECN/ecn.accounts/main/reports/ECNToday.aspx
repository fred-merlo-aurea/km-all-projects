<%@ Page Language="c#" Inherits="ecn.accounts.main.reports.ECNToday" CodeBehind="ECNToday.aspx.cs" MasterPageFile="~/MasterPages/Accounts.Master" %>
                    ...
                    <tr>
                        <td class="offWhite borderSides">
                            <table cellspacing="2" cellpadding="5" border='0' width="100%" class="formLabel"
                                ...
                                <tr>
                                    <td align='right'>
                                        <b>Test Blast Only&nbsp;:&nbsp;</b></td>
                                    <td align="left">
                                        <asp:checkbox id="chkTestBlastOnly" runat="Server"></asp:checkbox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table cellspacing="2" cellpadding="5" border='0' width="100%" class="formLabel"
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" align="left">
                                        <asp:radiobuttonlist id="rbReportType" cssclass="label10" runat="Server">
											<asp:ListItem value="1" Text="Blast Report" selected="true" />
											<asp:ListItem value="2" Text="New Customer Report" />
											<asp:ListItem value="3" Text="New User Report" />
										</asp:radiobuttonlist>
                                    </td>
                                </tr>
                            </table>
