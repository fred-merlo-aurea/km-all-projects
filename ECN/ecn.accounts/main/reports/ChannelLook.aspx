<%@ Page Language="c#" Inherits="ecn.accounts.main.reports.ChannelLook" CodeBehind="ChannelLook.aspx.cs"
                    ...
                    <tr>
                        ...
                        <td class="offWhite borderSides" valign="top">
                            <table cellspacing="2" cellpadding="5" border='0' width="100%" class="formLabel"
                                ...
                                <tr>
                                    <td align='right'>
                                        <b>Include blast Details&nbsp;:&nbsp;</b>
                                    </td>
                                    <td align="left">
                                        <asp:CheckBox ID="chkIncludeBlstDetails" runat="Server"></asp:CheckBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align='right'>
                                    ...
                                    <td valign="middle" align="left">
                                        <asp:RadioButtonList ID="rbReportType" CssClass="label10" runat="Server">
                                            ...
                                            <asp:ListItem Value="2" Text="No Usage Report" />
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                            </table>
