...
namespace EmailMarketing.API
{
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            //config.Formatters.Add(new EmailMarketing.API.Formatters.CustomXmlFormatter());
            ...
            {
                Order = 4,
                ExceptionHandlers = new List<Exceptions.ExceptionConfiguration>(EmailMarketing.API.Exceptions.ExceptionConfigurationLibrary.GetExceptionHandlers())
            });*/
