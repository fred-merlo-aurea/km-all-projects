...
using System.Linq;
using AutoFixture;
using ECN_Framework_Entities.Creator;
using ECN_Framework_EntitiesTests.ConfigureProject;
using NUnit.Framework;
using Shouldly;

namespace ECN_Framework_Entities.Tests.Creator
{
    [TestFixture]
    public class CodeTest : AbstractGenericTest
    {
        ...
        public void Code_Class_All_Properties_Getter_Settter_Test()
        {
            ...
            var codeTypeCode = Fixture.Create<ECN_Framework_Common.Objects.Creator.Enums.CodeType>();
        ...
        #region General Getters/Setters : Class (Code) => Property (CodeTypeCode) Property Type Test Except String

        [Test]
        [ExcludeFromCodeCoverage]
        [Author("AUT. Md. Alim Ul Karim")]
        [Category("AUT GetterSetter")]
        public void Code_CodeTypeCode_Property_Setting_String_Throw_Argument_Exception_Test()
        {
            // Arrange
            const string propertyNameCodeTypeCode = "CodeTypeCode";
            var code = Fixture.Create<Code>();
            var randomString = Fixture.Create<string>();
            var propertyInfo = code.GetType().GetProperty(propertyNameCodeTypeCode);
        ...
        #region General Getters/Setters : Class (Code) => Property (CodeTypeCode) Exists tests

        [Test]
        [Author("AUT. Md. Alim Ul Karim")]
        [Category("AUT GetterSetter")]
        public void Code_Class_Invalid_Property_CodeTypeCodeNotPresent_Access_Using_Reflexion_Doesnt_Throw_Exception_Test()
        {
            // Arrange
            const string propertyNameCodeTypeCode = "CodeTypeCodeNotPresent";
            var code  = Fixture.Create<Code>();

            // Act , Assert
            Should.NotThrow(() => code.GetType().GetProperty(propertyNameCodeTypeCode));
        }

        [Test]
        [Author("AUT. Md. Alim Ul Karim")]
        [Category("AUT GetterSetter")]
        public void Code_CodeTypeCode_Property_Is_Present_In_Class_As_Public_Test()
        {
            // Arrange
            const string propertyNameCodeTypeCode = "CodeTypeCode";
            var code  = Fixture.Create<Code>();
        ...
        #region General Getters/Setters : Class (Code) => Property (SortCode) Nullable Property Test

        [Test]
        [Author("AUT. Md. Alim Ul Karim")]
        [Category("AUT GetterSetter")]
        public void Code_SortCode_Property_Data_Without_Null_Test()
        {
            // Arrange
            var code = Fixture.Create<Code>();
            var random = Fixture.Create<int>();
        ...
        [Author("AUT. Md. Alim Ul Karim")]
        [Category("AUT GetterSetter")]
        public void Code_SortCode_Property_Only_Null_Data_Test()
        {
            // Arrange
            var code = Fixture.Create<Code>();
        ...
        [Author("AUT. Md. Alim Ul Karim")]
        [Category("AUT GetterSetter")]
        public void Code_SortCode_Property_Can_Be_Set_To_Null_Using_Reflection_Test()
        {
            // Arrange    
            const string propertyNameSortCode = "SortCode";
            var code = Fixture.Create<Code>();
            var propertyInfo = code.GetType().GetProperty(propertyNameSortCode);
        ...
        #region General Getters/Setters : Class (Code) => Property (SortCode) Exists tests

        [Test]
        [Author("AUT. Md. Alim Ul Karim")]
        [Category("AUT GetterSetter")]
        public void Code_Class_Invalid_Property_SortCodeNotPresent_Access_Using_Reflexion_Doesnt_Throw_Exception_Test()
        {
            // Arrange
            const string propertyNameSortCode = "SortCodeNotPresent";
            var code  = Fixture.Create<Code>();

            // Act , Assert
            Should.NotThrow(() => code.GetType().GetProperty(propertyNameSortCode));
        }

        [Test]
        [Author("AUT. Md. Alim Ul Karim")]
        [Category("AUT GetterSetter")]
        public void Code_SortCode_Property_Is_Present_In_Class_As_Public_Test()
        {
            // Arrange
            const string propertyNameSortCode = "SortCode";
            var code  = Fixture.Create<Code>();
        ...
        #region General Getters/Setters : Class (Code) => Property (SystemFlag) (Type : string) Property Type test 

        [Test]
        [Author("AUT. Md. Alim Ul Karim")]
        [Category("AUT GetterSetter")]
        public void Code_SystemFlag_Property_String_Type_Verify_Test()
        {
            // Arrange
            var code = Fixture.Create<Code>();
            code.SystemFlag = Fixture.Create<string>();
        ...
        #region General Getters/Setters : Class (Code) => Property (SystemFlag) Exists tests

        [Test]
        [Author("AUT. Md. Alim Ul Karim")]
        [Category("AUT GetterSetter")]
        public void Code_Class_Invalid_Property_SystemFlagNotPresent_Access_Using_Reflexion_Doesnt_Throw_Exception_Test()
        {
            // Arrange
            const string propertyNameSystemFlag = "SystemFlagNotPresent";
            var code  = Fixture.Create<Code>();

            // Act , Assert
            Should.NotThrow(() => code.GetType().GetProperty(propertyNameSystemFlag));
        }

        [Test]
        [Author("AUT. Md. Alim Ul Karim")]
        [Category("AUT GetterSetter")]
        public void Code_SystemFlag_Property_Is_Present_In_Class_As_Public_Test()
        {
            // Arrange
            const string propertyNameSystemFlag = "SystemFlag";
            var code  = Fixture.Create<Code>();
            var propertyInfo  = code.GetType().GetProperty(propertyNameSystemFlag);
        ...
        public void Constructor_Code_Instantiated_With_Default_Assignments_Test()
        {
            ...
            var codeTypeCode = ECN_Framework_Common.Objects.Creator.Enums.CodeType.Unknown;
