...
namespace ActiveUp.WebControls
{
	...
	internal class UploadAppletControlDesigner : ControlDesigner
	{
		/// <summary>
		/// The default constructor.
		/// </summary>
		public UploadAppletControlDesigner()
		{
			//
		...
		{
			UploadApplet uploadApplet = (UploadApplet)base.Component;
...
#if (!FX1_1)
            writer.AddAttribute(HtmlTextWriterAttribute.Src, Utils.ConvertToImageDir(string.Empty, string.Empty, "UploadAppletDesigner.jpg", uploadApplet.Page, uploadApplet.GetType()));
            writer.RenderBeginTag(HtmlTextWriterTag.Img);
            writer.RenderEndTag();
#else
			writer.Write("[Upload Applet ({0})]",uploadApplet.ClientID);
#endif
