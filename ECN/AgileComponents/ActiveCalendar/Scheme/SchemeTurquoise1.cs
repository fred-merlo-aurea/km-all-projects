...
namespace ActiveUp.WebControls.Scheme
{
	...
	/// Scheme Turquoise1.
	/// </summary>
	internal class SchemeTurquoise1 : SchemePreset
	{
		/// <summary>
		/// The default constructor.
		/// </summary>
		public SchemeTurquoise1() : base()
		{
			//
			...
			_weekendEndDayStyle.BackColor = Color.FromName(KnownColor.PaleTurquoise.ToString());
