...
{
	var chAndCustID = getChannelandCustID();
	var fileBrowserURLWithParams = FCKConfig.LinkBrowserURL+ '' + chAndCustID;
	//alert(fileBrowserURLWithParams);
	//OpenFileBrowser( FCKConfig.LinkBrowserURL, FCKConfig.LinkBrowserWindowWidth, FCKConfig.LinkBrowserWindowHeight ) ;
	OpenFileBrowser( fileBrowserURLWithParams, FCKConfig.LinkBrowserWindowWidth, FCKConfig.LinkBrowserWindowHeight ) ;
}
...
function conversion()  {
	var newURL = "";
	if(cmbLinkProtocol.value == "http://" || cmbLinkProtocol.value == "https://"){
