...
FCKCommands.GetCommand = function( commandName )
{
	...
	switch ( commandName )
	{
		...
		case 'Smiley'		: oCommand = new FCKDialogCommand( 'Smiley'		, FCKLang.DlgSmileyTitle		, 'dialog/transnippets.aspx'		, 600, 500 ) ; break ;
		...
		case 'FontSize'		: oCommand = new FCKStyleCommand() ; break ;
