        ...
        contents: [{
            ...
            elements: [{
                ...
                children: [{
                    ...
                    type: 'checkbox',
                    id: 'agree',
                    label: 'Add Conversion Tracking Code to URL',
                    onClick: function () {
                        var F = this.getDialog();
                        var K = F.getContentElement('info', 'protocol');
                        var newURL = "";
                        var G = F.getContentElement('info', 'url');
                        if (F.getValueOf('info', 'protocol') == "http://" || F.getValueOf('info', 'protocol') == "https://") {
                            if (this.getValue() == true) {
                                if (F.getValueOf('info', 'url') == "") {
                                    alert('Please Enter a valid URL');
                                    this.setValue(false);
                                } else {
                                    var media = window.showModalDialog("/ecn.editor/ckeditor/plugins/link/conversionTrackingCheck.aspx", null, "dialogWidth:1px;dialogHeight:1px;center:yes; resizable: yes; help: no");
                                    if (media != null) {
                                        if (media == "true") {
                                            newURL = F.getValueOf('info', 'url') + "%%ConversionTrkCDE%%";
                                            G.setValue(newURL);
                                        }
                                        else {
                                            alert('No Access');
                                ...
                                newURL = F.getValueOf('info', 'url');
                                G.setValue(newURL.substring(0, (newURL.length - 20)));
                            }
                        } else {
