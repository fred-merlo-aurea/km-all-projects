<%@ Page Language="c#" AutoEventWireup="false" Inherits="ecn.communicator.ckeditor.dialog.htmlUpload" CodeBehind="htmlUpload.aspx.cs" ValidateRequest="false" %>
...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        function ok() {
            var result = document.getElementById('<%= hfContentSource.ClientID %>');
            var type = window.location.search.substring(window.location.search.indexOf('=') + 1);
            if (window.opener) {
...
<body bottommargin="5" leftmargin="5" topmargin="5" rightmargin="5">
    <form runat="server">
        ...
        <input id="hfContentSource" type="hidden" runat="server" value="" />
