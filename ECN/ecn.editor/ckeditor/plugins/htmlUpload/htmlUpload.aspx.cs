...
namespace ecn.communicator.ckeditor.dialog
{
    public partial class htmlUpload : System.Web.UI.Page
    {
        ...
        public string getCustomerID()
        {
            try
            {
                if (ECN_Framework_BusinessLayer.Application.ECNSession.CurrentSession().CurrentCustomer.PlatformClientID > 0)
                    return ECN_Framework_BusinessLayer.Application.ECNSession.CurrentSession().CurrentCustomer.PlatformClientID.ToString();
                else
