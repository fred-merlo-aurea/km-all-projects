<%@ Reference Control="~/ckeditor/controls/uploader.ascx" %>
<%@ Control Language="c#" Inherits="ecn.editor.ckeditor.controls.imageGallery" Codebehind="imageGallery.ascx.cs" %>
...
<table cellpadding="0" cellspacing="0" width="100%">
											...
											<asp:datagrid id="ImageListGrid" runat="server" CssClass="gridWizard" OnSortCommand="ImageList_Sort"
												...
												<Columns>
                                                    ...
                                                    <asp:TemplateColumn  HeaderText="INSERT" ItemStyle-Width="10%">
														<ItemTemplate>
															<a href="javascript:void(0)" onclick=JavaScript:getit('<%#DataBinder.Eval(Container.DataItem,"ImageKey")%>')><img src='/ecn.images/images/icon-add.gif' border=0 ></a>
														</ItemTemplate>
													</asp:TemplateColumn>
																...
																<div style="width:175px;border:0">
																	<table cellpadding=0 cellspacing=0 border="0" width="100%">
																		...
																		<tr>
																			...
																			<td width="20" align="left"><a href="javascript:void(0)" onclick=JavaScript:getit('<%#DataBinder.Eval(Container.DataItem,"ImageKey")%>')><img src="/ecn.images/images/icon-add.gif" border=0 ></a></td>
	...
	<asp:Panel ID="PanelUpload2" Visible="false" Runat="server">
		<TR>
			<TD colSpan="2" class="offWhite">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						<TD class="grd_panel_borders" align="center">
							<ecn:uploader id="pageuploader" runat="server" uploadDirectory=""></ecn:uploader><BR>
							<BR>
							<BR>
						</TD>
					</TR>
