...
(function () {
    ...
    j.add('colorbutton', {
        ...
        init: function (m) {
            ...
            function r(t, u, v) {
                ...
                w.push('<a class="cke_colorauto" _cke_focus=1 hidefocus=true title="', o.auto, '" onclick="CKEDITOR.tools.callFunction(', z, ",null,'", u, "');return false;\" href=\"javascript:void('", o.auto, '\')" role="option" aria-posinset="1" aria-setsize="', y, '"><table role="presentation" cellspacing=0 cellpadding=0 width="100%"><tr><td colspan=8 align=center>', o.auto, '</td></tr></table></a><table role="presentation" cellspacing=0 cellpadding=0 width="100%">');
    ...
    (function () {
        var m = {
            ...
            exec: function (o) {
                ...
                var A = window.open(z, null, 'toolbar=yes,location=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,width=' + v + ',height=' + w + ',left=' + x);
                if (!s) {
                    var B = A.document;
                    B.open();
                    B.write(p);
    ...
    {
        name: 'insert',
        items: ['Image', 'Table', 'HorizontalRule', 'PageBreak', 'SpecialChar'] 
    },
    {
        name: 'tools',
    ...
    i.toolbar_Full = [{
        name: 'document',
        items: ['Source', '-', 'DocProps', 'Preview', 'Print', '-',  'xmltemplates'] //'Save', 'NewPage',
    }, {
        name: 'clipboard',
        items: ['Cut', 'Copy', 'Paste', 'PasteText', 'PasteFromWord', '-', 'Undo', 'Redo']
    }, {
    ...
    {
        name: 'insert',
        items: ['Image', 'Table', 'HorizontalRule', 'PageBreak', 'SpecialChar', 'codesnippet', 'transnippet', 'dynamictag', 'htmlUpload', 'socialshare','rssfeed'] //'Flash', 'Iframe','Smiley'
    },
    {
        name: 'tools',
        items: ['Maximize', 'ShowBlocks', '-', 'About'] //
