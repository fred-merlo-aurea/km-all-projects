...
<%@ Page language="c#" AutoEventWireup="false" CodeBehind="browse.aspx.cs" Inherits="ecn.communicator.contentmanager.editor.browse" %>
...
protected override void OnLoad(EventArgs e) {
	...
	string ImagesWebPath=cc.getAssetsPath("accounts")+"/channelID_"+securityCheck.ChannelID()+"/customers/"+securityCheck.CustomerID()+"/images/";
