...
function TBToolbar_GetHTML() 
{
	...
	{
		sHTML += '<TABLE class="Toolbar" cellspacing="0" cellpadding="1" border="0" unselectable="on"><TR>' ;
		
		oBand = this.Bands.Array[iBand]
		for (iItem = 0 ; iItem < oBand.Items.Array.length ; iItem++)
		{
			sHTML += '<TD><font face=verdana size=1>' + oBand.Items.Array[iItem].GetHTML() + '</font></TD>' ;
		}
