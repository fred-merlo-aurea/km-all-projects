...
namespace ECN.Communicator.Tests.Includes
{
    ...
    public partial class EmailProfileBaseTest
    {
        ...
        private void AssertPageControlValuesForLoadProfileData()
        {
            ...
            txtFullName.Text.ShouldBe(FullNameValue);
            ...
            ddlFormatTypeCode.SelectedItem.Text.ShouldBe(FormatTypeCodeValue);
            txtNotes.Text.ShouldBe(NotesValue);
        }
        ...
        private Dictionary<string, object> GetDataRowDictionary()
        {
            ...
            colValueDictionary.Add(FullNameColumnName, FullNameValue);
            ...
            colValueDictionary.Add(FormatTypeCodeColumnName, FormatTypeCodeValue);
            colValueDictionary.Add(NotesColumnName, NotesValue);
        ...
        private void InitializePageControls()
        {
            ...
            ddlFormatTypeCode = new DropDownList();
            ddlFormatTypeCode.Items.Add(FormatTypeCodeControlItem1);
            ddlFormatTypeCode.Items.Add(FormatTypeCodeControlItem2);
            ...
            _emailProfileBasePrivateObject.SetField(FormatTypeCodeControlName, ddlFormatTypeCode);
            _emailProfileBasePrivateObject.SetField(NotesControlName, txtNotes);
        }
