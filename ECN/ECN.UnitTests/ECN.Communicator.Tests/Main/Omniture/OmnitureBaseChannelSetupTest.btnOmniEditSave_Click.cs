...
namespace ECN.Communicator.Tests.Main.Omniture
{
    ...
    public class OmnitureBaseChannelSetupTestbtnOmniEditSave_Click
    {
        ...
        private const string OptionsTableStateKey = "ParamOptionsBaseDT";
        ...
        public void btnOmniEditSave_Click_LinkTrackingParamSettingsHasNoId_ShouldInsert()
        {
            ...
            _viewState["ParamOptionBaseID"] = paramId;
            _currentBaseChannel.BaseChannelID = GetNumber();
            //Act
            CallbtnOmniEditSave_Click();
            //Assert
            _linkTrackingParamSettingsInserted.ShouldSatisfyAllConditions(
                ...
                () => _linkTrackingParamSettingsInserted.BaseChannelID.ShouldBe(_currentBaseChannel.BaseChannelID));
        }
        ...
        public void btnOmniEditSave_Click_DynamicFieldsSelected_ShouldAddRow()
        {
            ...
            _viewState[OptionsTableStateKey] = table;
            //Act
            CallbtnOmniEditSave_Click();
            //Assert
        ...
        public void btnOmniEditSave_Click_RowsNeedInsert_ShouldBeInserted()
        {
            ...
            table.Rows.Add(row);
            _viewState[OptionsTableStateKey] = table;
            var baseChannelId = GetNumber();
            _currentBaseChannel.BaseChannelID = baseChannelId;
            //Act
            CallbtnOmniEditSave_Click();
            //Assert
            _linkTrackingParamOptionInserted.ShouldSatisfyAllConditions(
                ...
                () => _linkTrackingParamOptionInserted.BaseChannelID.ShouldBe(baseChannelId),
        ...
        private void CommonShims()
        {
            ...
            ShimLinkTrackingParamSettings.Get_LTPID_BaseChannelIDInt32Int32 = (ltpId, baseChannel) =>
            {
            ...
            ShimLinkTrackingParamOption.Get_LTPID_BaseChannelIDInt32Int32 = (paramId, customerId) =>
            {
        ...
        private ECNSession GetSession()
        {
            ...
            result.CurrentBaseChannel = _currentBaseChannel;
            return result;
        }
