...
{
    /// <summary>
    ///     Unit tests for <see cref="ecn.communicator.main.ECNWizard.Controls.WizardPreview"/>
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public partial class WizardPreviewTest
    {
        ...
        [Test]
        public void Initialize_WizardPreview_Success()
        {
            // Arrange
            InitilizeFakes();
            InitilizeTestObject();
        ...
        public void Initialize_WhenIgnoreSuppressionIsTrue_TransactionalEmailErrorIsShown()
        {
            ...
            _testObject.ShouldSatisfyAllConditions(
                () => transactionalLabel.ShouldNotBeNull(),
        ...
        {
            var wizardPreview = new WizardPreview();
        ...
        {
            _testObject.SetField("lblFromEmail", new Label());
            _testObject.SetField("lblReplyTo", new Label());
            _testObject.SetField("lblFromName", new Label());
            _testObject.SetField("lblSubject", new Label());
            _testObject.SetField("lblSelectedMessage", new Label()); 
            _testObject.SetField("lblMessage", new Label());
            ...
            _testObject.SetField("lblFromEmail_DP", new Label());
            _testObject.SetField("lblReplyTo_DP", new Label());
            _testObject.SetField("lblFromName_DP", new Label());
            ...
            _testObject.SetField("hlPreviewHTML", new HyperLink());
            _testObject.SetField("hlPreviewTEXT", new HyperLink());
            _testObject.SetField("pnlBlastFields", new Panel());
            _testObject.SetField("pnlDynamicPersonalization", new Panel());
        }

        private void AssertPropertiesAndFields()
        {
            _campaignItemObject?.BlastList.ShouldNotBeEmpty();
            var firstBlast = _campaignItemObject?.BlastList[0] as CampaignItemBlast;
            var emailReplyTo = (_testObject.GetFieldOrProperty("lblReplyTo") as Label)?.Text;
            var emailFrom = (_testObject.GetFieldOrProperty("lblFromName") as Label)?.Text;
            var emailSubject = (_testObject.GetFieldOrProperty("lblSubject") as Label)?.Text;
            _testObject.ShouldSatisfyAllConditions(
                () => firstBlast.ShouldNotBeNull(),
                () => emailSubject.ShouldBe(firstBlast.EmailSubject),
                () => emailReplyTo.ShouldBe(_campaignItemObject.ReplyTo),
                () => emailFrom.ShouldBe(_campaignItemObject.FromName));
        }
