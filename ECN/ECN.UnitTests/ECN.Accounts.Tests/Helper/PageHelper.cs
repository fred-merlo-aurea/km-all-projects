...
namespace ECN.Accounts.Tests.Helper
{
    ...
    public abstract class PageHelper
    {
        ...
        protected string CustomerRootDirectoryName { get; set; } = "\\customers\\";
        ...
        protected virtual void SetPageSessionContext()
        {
            ...
            {
                MapPathString = (path) => $"{CurrentContext.TestDirectory}{path?.Replace("/","\\") ?? string.Empty}"
            };
         }
        ...
        public void CleanUp()
        {
            _shimObject.Dispose();
            context = null;
            var fullPath = $"{CurrentContext.TestDirectory}{CustomerRootDirectoryName}";
