...
{
    /// <summary>
    ///     Unit tests for <see cref="ecn.webservice.Global"/>
    /// </summary>
    [TestFixture, ExcludeFromCodeCoverage]
    public partial class GlobalTest
    {
        private IDisposable _shimObject;
        private PrivateObject _mvcApplication = new PrivateObject(new ecn.webservice.Global());
        ...
        public void TestInitialize()
        {
            ...
            _mvcApplication = new PrivateObject(new ecn.webservice.Global());
            ...
            {
                TransferString = (url) => _redirectionPath = url
            };
            ...
            KM.Common.Entity.Fakes.ShimApplicationLog.LogNonCriticalErrorStringStringInt32StringInt32Int32 =
