...
namespace ECN.MarketinAutomation.Tests.Models.PostModels.Controls
{
    ...
    public class FormAbandonTest: ControlBaseTest
    {
        private FormAbandon _control;

        [SetUp]
        public void Setup()
        {
            _control = new FormAbandon();
            InitParentControls();
            InitMocks();
        ...
        {
            // Assert
            AssertCampaignControlBaseDefaultValues(_control, Enums.MarketingAutomationControlType.FormAbandon);
        }
        ...
        public void DefaultInstanceSerialization_NewInstanceCreatedAndSerializedToJson_CorrectJsonGenerated()
        {
            ...
            var expectedJObject = JObject.Parse(ControlTestConsts.FormAbandonDefaultExpectedJson);
        ...
        public void UpdatedInstanceSerialization_InstancePropertiesUpdatedAndSerializedToJson_CorrectJsonGenerated()
        {
            ...
            var json = JsonConvert.SerializeObject(_control);
            var actuallJObject = JObject.Parse(json);
            var expectedJObject = JObject.Parse(ControlTestConsts.FormAbandonModifiedExpectedJson);
