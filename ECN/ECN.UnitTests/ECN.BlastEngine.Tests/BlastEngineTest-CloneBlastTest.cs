...
namespace ECN.BlastEngine.Tests
{
    ...
    {
        private const string METHOD_CloneBlast = "CloneBlast";
        ...
        [Test]
        public void CloneBlast_CampaignItemSuppressionListExist_ReachEnd()
        {
            // Arrange
            var exceptionLogged = false;
            var reachedEnd = false;
        ...
        [Test]
        public void CloneBlast_CampaignItemBlastFiltersExist_ReachEnd()
        {
            // Arrange
            var exceptionLogged = false;
            var reachedEnd = false;
        ...
        [Test]
        public void CloneBlast_CampaignItemBlastSmartSegmentFiltersExist_ReachEnd()
        {
            // Arrange
            var exceptionLogged = false;
            var reachedEnd = false;
