...
namespace ECN.Collector.Tests
{
    ...
    public class GolbalTestApplication_ErrorLogCoverage
    {
        ...
        private PrivateObject _mvcApplication = new PrivateObject(new ecn.collector.Global());
        ...
        public void TestInitialize()
        {
            ...
            _mvcApplication = new PrivateObject(new ecn.collector.Global());
