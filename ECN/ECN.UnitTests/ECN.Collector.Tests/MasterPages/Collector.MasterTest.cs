...
using Shouldly;
using Master = ecn.collector.MasterPages;

namespace ECN.Collector.Tests.MasterPages
{
    /// <summary>
    ...
    [TestFixture]
    class CollectorTest : PageHelper
    {
        private Master.Collector _testPage;
        private PrivateObject _testObject;

        [SetUp]
        public void SetUp()
        {
            _testPage = new Master.Collector();
        ...
        public void DrpAccount_SelectedIndexChanged_CreateCookie_Redirect()
        {
            ...
            _testObject.ShouldSatisfyAllConditions(
                () => RedirectUrl.ShouldBe("~/main/survey/default.aspx"),
