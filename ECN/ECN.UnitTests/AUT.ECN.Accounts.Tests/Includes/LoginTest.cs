...
namespace AUT.ECN.Accounts.Tests.Includes
{
    ...
    public class LoginTest : AbstractGenericTest
    {
        ...
        public void login_ProcessLogin_Method_With_3_Parameters_Call_With_Reflection_No_Exception_Thrown_Test()
        {
            // Arrange
            var strUser = Fixture.Create<String>();
            var strPassword = Fixture.Create<String>();
            var chkPersistLogin = Fixture.Create<bool>();
            Object[] parametersOfProcessLogin = {strUser, strPassword, chkPersistLogin};
        ...
        [Author("AUT. Md. Alim Ul Karim")]
        [Category("AUT MethodCallTest")]
        public void login_ProcessLogin_Method_With_3_Parameters_Call_With_Reflection_Exception_Thrown_Test()
        {
            // Arrange
            var strUser = Fixture.Create<String>();
            var strPassword = Fixture.Create<String>();
            var chkPersistLogin = Fixture.Create<bool>();
            Object[] parametersOutRanged = {strUser, strPassword, chkPersistLogin, null};
            Object[] parametersInDifferentNumber = {strUser, strPassword};
