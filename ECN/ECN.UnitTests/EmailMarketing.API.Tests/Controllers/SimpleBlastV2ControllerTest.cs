...
{
    /// <summary>
    ///     Unit tests for <see cref="EmailMarketing.API.Controllers.SimpleBlastV2Controller"/>
    /// </summary>
    [TestFixture]
    ...
    public partial class SimpleBlastV2ControllerTest
    {
        ...
        private SimpleBlastV2Controller CreateController()
        {
            var testObject = new SimpleBlastV2Controller();
            testObject.Request = new HttpRequestMessage();
            return testObject;
        }

        private SimpleBlastV2 CreateModel()
        {
            return new SimpleBlastV2
            {
                BlastID = 1,
        ...
        private void InitilizeHttpFakes()
        {
            ...
            ShimAuthenticatedUserControllerBase.AllInstances.CreateResponseWithLocationOf1HttpStatusCodeM0Int32String(
                (AuthenticatedUserControllerBase instance, HttpStatusCode statusCode, SimpleBlastV2 model, int id, string routeName) =>
                {
