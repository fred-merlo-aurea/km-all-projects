...
{
    /// <summary>
    ///     Unit tests for <see cref="ecn.activityengines"/>
    /// </summary>
    [TestFixture, ExcludeFromCodeCoverage]
    public partial class GlobalTest
    {
        private IDisposable _shimObject;
        private PrivateObject _mvcApplication = new PrivateObject(new Global());
        ...
        public void TestInitialize()
        {
            ...
            _mvcApplication = new PrivateObject(new Global());
            ...
            {
                TransferStringBoolean = (url, ignore) => _redirectionPath = url
            };
