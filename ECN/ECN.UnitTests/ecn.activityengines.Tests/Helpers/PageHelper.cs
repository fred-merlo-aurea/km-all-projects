...
namespace ecn.activityengines.Tests.Helpers
{
    ...
    public abstract class PageHelper
    {
        ...
        protected string ResponseWriteText { get; set; } = string.Empty;
        ...
        protected virtual void SetPageSessionContext()
        {
            ...
            ResponseWriteText = string.Empty;
            ...
            ShimHttpApplication.AllInstances.ResponseGet = (h) => new HttpResponse(TextWriter.Null);
            ...
            ShimHttpResponse.AllInstances.WriteString = (res, text) => { ResponseWriteText += text; };
        }
