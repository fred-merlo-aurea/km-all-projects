    ...
    public class GetDataTableByFileTypeTest : Fakes
    {
            ...
            bool shouldThrowException = false)
        {
            ...
            ShimDbDataAdapter.AllInstances.FillDataSetInt32Int32String = 
                (adapter, set, pStartLine, pMaxRecordsToRetrieve, pFileName) =>
                    {
            ...
            ShimOleDbDataAdapter.ConstructorStringString = (paramAdapter, paramQueryString, paramConnStr) =>
            {
                calledQueryString = paramQueryString;
                calledConnStr = paramConnStr;
            };
