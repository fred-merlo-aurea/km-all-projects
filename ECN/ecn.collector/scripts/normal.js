...
var gBegin=[1995,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
...
var gcCalFrame="#999999";	// the background color of the inner table, showing as a frame.
...
var gcSatBG="#d2eefc";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#d2eefc";	// Sunday background color
...
var gcToggle="#fdd198";	// the highlight color for the focused cell

var gcFGToday="red";	// the font color for today 
var gcBGToday="#e5e5e5";	// the background color for today 
