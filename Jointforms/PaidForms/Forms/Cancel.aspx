<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Cancel.aspx.cs" Inherits="PaidForms.Forms.Cancel" %>
...
<body>
    ...
    <div class="container" style="max-width: 800px; padding: 40px 20px;">
        ...
        <asp:Panel ID="pnlContent" runat="server">
            <table>
                <tr>
                    <td>Your payment was not processed due to cancellation.
                    </td>
                </tr>
                <tr>
                    <td>
