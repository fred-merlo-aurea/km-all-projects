<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EffortKey.aspx.cs" Inherits="PharmaLiveReporting.main.EffortKey" %>
                ...
                <tr class="gridheader" style="padding-right: 4px; padding-left: 8px; padding-bottom: 4px;
                    ...
                    <td align="left">
                        <span style="font-weight: bold; font-size: 8pt; color: #000000; font-style: normal;
                            font-family: Arial">Effort Key Report Parameters</span></td>
                </tr>
                <tr>
                    <td>
                                ...
                                <td align="left" width="15%" valign="top">
                                    ...
                                    <asp:TextBox ID="txtQFrom" Width="100" CssClass="formfield" MaxLength="10" runat="server"></asp:TextBox><img
                                        ...
                                        src="http://images.ecn5.com/Images/icon-calendar.gif" align="absMiddle">&nbsp;<asp:RangeValidator
                                            ...
                                            MaximumValue="12/31/2050" MinimumValue="01/01/1950" Type="Date"></asp:RangeValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtQFrom"
                                    ...
                                    <asp:TextBox ID="txtQTo" Width="100" runat="server" CssClass="formfield" MaxLength="10"></asp:TextBox><img
                                        ...
                                        src="http://images.ecn5.com/Images/icon-calendar.gif" align="absMiddle">&nbsp;<asp:RangeValidator
                                            ...
                                            MaximumValue="12/31/2050" MinimumValue="01/01/1950" Type="Date"></asp:RangeValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtQTo"
