<%@ Page Language="C#" AutoEventWireup="true" Codebehind="3aReport.aspx.cs" Inherits="PharmaLiveReporting._aReport" %>
                ...
                <tr class="gridheader" style="padding-right: 4px; padding-left: 8px; padding-bottom: 4px;
                    ...
                    <td align="left">
                        <span style="font-weight: bold; font-size: 8pt; color: #000000; font-style: normal;
                            font-family: Arial">3a Report Parameters</span></td>
                </tr>
                <tr>
                    <td>
                        <table style="width: 100%" cellspacing="0" cellpadding="5" border="0">
                            <tr>
                                <!--<td align="left" width="20%" valign="top">
                                    Business :<br />
                                    <br />
                                    &nbsp;<asp:ListBox ID="lstBusiness" runat="server" SelectionMode="Multiple" DataTextField="text"
                                        DataValueField="value" Width="250px" Rows="8" Font-Names="Arial" Font-Size="x-small">
                                    </asp:ListBox><br>
                                    <br>
                                </td>
                                <td align="left" width="20%" valign="top">
                                    Industry :<br />
                                    <br />
                                    &nbsp;<asp:ListBox ID="lstIndustry" runat="server" SelectionMode="Multiple" DataTextField="text"
                                        DataValueField="value" Width="250px" Rows="8" Font-Names="Arial" Font-Size="x-small">
                                    </asp:ListBox>
                                </td>-->
