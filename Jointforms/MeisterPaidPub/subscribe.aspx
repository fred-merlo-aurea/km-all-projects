...
<head id="Head1" runat="server">
    <title>Meister Media Paid Subscription Form</title>
                                        ...
                                        <asp:GridView ID="grdMagazines" runat="server" AutoGenerateColumns="false" HorizontalAlign="Center"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Cover" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Image ID="lblImageID" runat="server" ImageUrl='<%# DataBinder.Eval(Container.DataItem,"coverImage") %>' Width="100px" Height="114px" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:CheckBox ID="chkAirMail" runat="server" AutoPostBack="true" Checked="false" OnCheckedChanged="chkAirMail_CheckedChanged"
                                                                        Visible="true" Text=" Airmail" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <asp:TemplateField HeaderText="Print Edition" ItemStyle-HorizontalAlign="Center"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblGroupID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"groupID") %>'
                                                            Visible="false" />
                                                        <asp:Label ID="lblAllowAirmail" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"allowairmail") %>'
                                                            Visible="false" />
                                                        ...
                                                        <asp:Label ID="lblIntPrice2" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"intpricetwo") %>'
                                                            Visible="false"></asp:Label>
                                                        <asp:Label ID="lblAirMailIntPrice1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"airmailintpriceone") %>'
                                                            Visible="false"></asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="Total Price" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle"
                                                    ItemStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTotal" runat="server" Visible="true" Text="$0.00" />
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                        ...
                                        <table cellspacing="5" cellpadding="0" width="100%" border="0">
                                            <tbody>
                                                ...
                                                <tr valign="baseline">
                                                    ...
                                                    <td width="15%" align="left">
                                                        <span class="label">
                                                            <asp:Label ID="lblZip" runat="server" Text="* Zip Code:"></asp:Label></span>
                                                    </td>
                                                    <td width="35%">
