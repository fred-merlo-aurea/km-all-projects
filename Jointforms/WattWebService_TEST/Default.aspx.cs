...
namespace WattWebService_TEST
{
    public partial class _Default : System.Web.UI.Page
    {
        ...
        {
            WattService.KmWattService s = new WattService.KmWattService();
        ...
        protected void btnGetSubscriber_Click(object sender, EventArgs e)
        {
            ...
            WattService.CustomerData cd = s.GetProfile(AccessKey, txtGetEmailaddress.Text, drpPubCodes.SelectedItem.Value);
        ...
        protected void btnAddProfile_Click(object sender, EventArgs e)
        {
            ...
            {
                string AccessKey;
                WattService.CustomerData cd = new WattService.CustomerData();
