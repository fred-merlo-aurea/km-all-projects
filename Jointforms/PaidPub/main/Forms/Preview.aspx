<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Preview.aspx.cs" Inherits="PaidPub.main.Forms.Preview" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>Subscription Form - Preview</title>
        ...
        <div id="innerContainer">
            ...
            <asp:Panel ID="pnlLogin" runat="server" Visible="false">
                <div id="loginPanel" style="visibility: visible; width: 100%; text-align: center;"
                    ...
                    <br />
                    <table cellspacing="0" cellpadding="2" border="0" id="loginCtrl" style="background-color: #EFF3FB;
                        ...
                        <tr>
                            <td>
                                <table cellpadding="0" border="0" style="color: #333333; font-family: Verdana; font-size: 0.8em;
                                    ...
                                    <tr>
                                        <td align="center" valign="middle" colspan="2" style="color: White; background-color: #507CD1;
                                            font-size: 1.1em; font-weight: bold; height: 25px; width: 100%;">
                                            Log In
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                            <label for="loginCtrl_UserName">
                                                E-mail address:</label>
                                        </td>
                                        <td>
                                            <input name="UserName" type="text" id="UserName" style="font-size: 0.8em;
                                                width: 155px;" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                            <label for="loginCtrl_Password">
                                                Password:</label>
                                        </td>
                                        <td>
                                            <input name="Password" type="password" id="Password" style="font-size: 0.8em;
                                                width: 155px;" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" colspan="2">
                                        <asp:Button ID="btnLogin" Text="Next" runat="server" OnClick="btnLogin_Click" style="color: #284E98; background-color: White; border-color: #507CD1;
                                                border-width: 1px; border-style: Solid; font-family: Verdana; font-size: 0.8em;" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <a id="loginCtrl_PasswordRecoveryLink" href="#">Forgot your password.</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <asp:GridView ID="gvSubscribed" runat="server" DataKeyNames="groupID" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Renew" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="center"
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox runat="server" ID="chkRenew" onclick="ongridclickchange(this);" Visible='<%# DataBinder.Eval(Container.DataItem, "FREEorpaid")=="FREE"?false:true %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
            ...
            <asp:Panel ID="pnlStep2" runat="server" Visible="false">
                ...
                <div id="profile">
                    <p>
                        ...
                        <asp:TextBox runat="server" ID="txtfirstname" Width="200"></asp:TextBox>&nbsp;
                    </p>
                    <p>
                        <label>
                            <font color="#000000">Last Name:</font><font color="#ff0000">*&nbsp;</font></label>
                        <asp:TextBox runat="server" ID="txtlastname" Width="200"></asp:TextBox>&nbsp;
                    </p>
                    <p>
                        <label>
                    ...
                    <p>
                        ...
                        <asp:TextBox runat="server" ID="txtaddress" Width="200"></asp:TextBox>&nbsp;
                    </p>
                    <p>
                        <label>
                    ...
                    <p>
                        ...
                        <asp:TextBox runat="server" ID="txtcity" Width="200"></asp:TextBox>&nbsp;
                    </p>
                    <p>
                        <label>
                    ...
                    <p class="zip">
                        ...
                        <asp:TextBox runat="server" ID="txtzip" Width="200"></asp:TextBox>&nbsp;
                    </p>
                    <p class="country">
                        <label>
                        ...
                        <Columns>
                            <asp:BoundField DataField="GroupName" HeaderStyle-Width="40%" HeaderText="Newsletter(s)"
                             ...
                             <asp:TemplateField HeaderText="Regular Price" HeaderStyle-Width="15%" FooterStyle-HorizontalAlign="center"
                                ...
                                ItemStyle-Width="15%"  HeaderStyle-Font-Size="x-Small">
                                <ItemTemplate>
                ...
                <asp:Panel ID="pnlCheckout" runat="server">
                    <div style="padding-left: 2em; padding-right: 2em;">
                        ...
                        <div style="padding-left: 3em;">
                            ...
                            <br />
                            Canon Communications Pharmaceutical Media Group<br />
                            Subscription Services<br />
                            828A Newtown-Yardley Road<br />
                            Newtown, PA 18940<br />
                            <br />
                            Checks should be payable to: Canon Communications<br />
                            <br />
