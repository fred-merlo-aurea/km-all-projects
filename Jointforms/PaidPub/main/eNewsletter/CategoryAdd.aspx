<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CategoryAdd.aspx.cs" Inherits="PaidPub.main.eNewsletter.CategoryAdd" %>
<%@ MasterType VirtualPath="~/Site1.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <div class="contentheader">
        eNewsletters Category
    </div>
    <br />
    <div class="padding20">
        <div class="box">
