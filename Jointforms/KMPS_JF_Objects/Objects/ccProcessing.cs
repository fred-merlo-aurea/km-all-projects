...
namespace KMPS_JF_Objects.Objects
{
    ...
    public abstract class ccProcessing
    {
        ...
        /// <summary>
        /// This is the key to merchant account.  
        /// </summary>
        ...
        public string CreditCardExpirationFullYear
        {
            get;
            set;
        }
        ...
        public string ShippingAddressFirstName
        {
            get;
            set;
        }

        public string ShippingAddressLastName
        {
            get;
            set;
        }
        ...
        {
            get { return this.ShippingAddress1 + " " + this.ShippingAddress2; }
        }
        ...
        {
            get { return this.Address1 + " " + this.Address2; }
        }
        ...
        public virtual bool ValidateCard(Publication pub)
        {
