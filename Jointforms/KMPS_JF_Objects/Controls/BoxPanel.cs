...
namespace KMPS_JF_Objects.Controls
{
    ...
    public class BoxPanel : Panel
    {
        ...
        private void BuildControlTree(HtmlTextWriter output, string id, string panelOutput)
        {
            ...
            topleftCell.Width = Unit.Pixel(11);
            ...
            toprightCell.Width = Unit.Pixel(11);
            ...
            TableCell EmptyleftCell = new TableCell();
            EmptyleftCell.Height = Unit.Pixel(20);
            EmptyleftCell.CssClass = "boxleftside";
            rowEmpty.Cells.Add(EmptyleftCell);

            //Label Info
            TableCell EmptycenterCell = new TableCell();
            EmptycenterCell.Text = "&nbsp;";
            EmptycenterCell.BackColor = Color.White;
            rowEmpty.Cells.Add(EmptycenterCell);

            // Right most cell
            TableCell EmptyrightCell = new TableCell();
            EmptyrightCell.HorizontalAlign = HorizontalAlign.Right;
            EmptyrightCell.Height = Unit.Pixel(20);
            EmptyrightCell.CssClass = "boxrightside";
            rowEmpty.Cells.Add(EmptyrightCell);
