...
namespace KMPS_JF_Objects.Controls
{
    ...
    /// <summary>
    /// The CategorizedRadioButtonList is like a radiobuttonList, but with the ability to categorize the display of items.
    /// </summary>
    [Designer("KMPS_JF_Objects.Controls.CategorizedRadioButtonListControlDesigner"),
    DefaultProperty("DataTable"),
        ToolboxData("<{0}:ccbl runat=server></{0}:ccbl>")]
    public class CategorizedRadioButtonList : System.Web.UI.WebControls.WebControl
    {
        /// <summary>
        /// Initializes a new instance of the CategorizedRadioButtonList class.
        /// </summary>
        public CategorizedRadioButtonList()
        {
            // Init the class
        }
        ...
        /// <summary>
        /// The DataTable used to build the radiobutton list.
        /// </summary>
        ...
        [Category("Data"),
        DefaultValue(""),
        Description("The DataTable that will be used to build the radiobutton list.")]
        ...
        /// <summary>
        /// An ArrayList of the radiobutton values that should be marked as selected. 
        ...
        public string SelectedValue
        {
            get
            {
                ...
                if (HttpContext.Current.Request.Form.Count > 0 && (selectedvalue == string.Empty))
                {
        ...
        /// <summary>
        /// The name of the column that will be used for the text that is displayed next to the radiobuttones.
        /// </summary>
        ...
        [Category("Data"),
        DefaultValue(""),
        Description("Enabled AutoPostback for radiobuttones.")]
        ...
        [Category("Data"),
        DefaultValue(""),
        Description("The name of the column that will be used for the text that is displayed next to the radiobuttones.")]
        ...
        /// <summary>
        /// The name of the column that will be used for the value of the radiobuttones.
        /// </summary>
        ...
        [Category("Data"),
        DefaultValue(""),
        Description("The name of the column that will be used for the value of the radiobuttones.")]
        ...
        /// <summary>
        /// The name of the column that will be used to group the radiobuttones by category.
        /// </summary>
        ...
        [Category("Data"),
        DefaultValue(""),
        Description("The name of the column that will be used to group the radiobuttones by category.")]
        ...
        /// <summary>
        /// Optional from consumer. Controls the css class for each radiobutton.
        /// </summary>
        protected string radiobuttonCssClass;

        /// <summary>
        /// Controls the css class for each radiobutton. Optional.
        /// </summary>
        [Category("Appearance"),
        DefaultValue(""),
        Description("The CSS Class name for the radiobutton fields.")]
        public string RadiobuttonCssClass
        {
            get { return radiobuttonCssClass; }
            set { radiobuttonCssClass = value; }
        }


        /// <summary>
        /// Optional from consumer. Controls the css class for the text next to each radiobutton.
        /// </summary>
        protected string textCssClass;

        /// <summary>
        /// Optional from consumer. The CSS Class name for the text next to each radiobutton.
        /// </summary>
        [Category("Appearance"),
        DefaultValue(""),
        Description("The CSS Class name for the text next to each radiobutton.")]
        ...
        /// <summary>
        /// Optional from consumer. Determines whether all of the categories and radiobuttones will share the same table.
        /// </summary>
        protected bool sharedTable = false;

        /// <summary>
        /// Determines whether all of the categories and radiobuttones will share the same table.
        /// </summary>
        [Category("Appearance"),
        DefaultValue(""),
        Description("Determines whether all of the categories and radiobuttones will share the same table, or if each category will have its own table.")]
        ...
        /// <summary>
        /// The name (id) assigned to all of the radiobuttones in the list.
        /// </summary>
        protected string htmlFieldName;
       
        /// <summary>
        /// The total number of radiobutton items.
        /// </summary>
        ...
        [Category("Appearance"),
        DefaultValue(""),
        Description("The number of columns that will be used to layout the radiobutton items.")]
        public int Columns
        {
            get { return columns; }
            set { columns = value; }
        ...
        protected override void Render(HtmlTextWriter output)
        {
            try
            {
                ...
                {
                    // Yes. Render the html.
                    BuildCategorizedRadioButtonList(output);
            ...
            catch (Exception ex)
            {
                ...
                output.Write("Error building CategorizedRadioButtonList:<br>");
        ...
        /// <summary>
        /// <c>BuildCategorizedRadioButtonList</c> outputs the HTML for the control.
        /// </summary>
        /// <param name="output"></param>
        protected void BuildCategorizedRadioButtonList(HtmlTextWriter output)
        {
            int itemcount = 0;
            // Do we have any data?
            ...
            for (int i = 0; i < Categories.Count; i++)
            {
                ...
                for (int Row = 0; Row < totalRows; Row++)
                {
                    ...
                    for (int Col = 0; Col < columns; Col++)
                    {
                        ...
                        {
                            // Now add the radiobutton and text
                            Outputradiobutton(output,
                                htmlFieldName,
        ...
        /// <summary>
        /// Returns the unique field name that we will assogn to the radiobuttones, later. 
        /// </summary>
        ...
        protected void OutputCategoryRow(HtmlTextWriter output, string category)
        {
            ...
            if (TrimmedCat != "")
            {
                ...
                // one for the radiobutton, and another for the text.
                output.Write(Columns * 2);
        ...
        /// <summary>
        /// Outputs the html for an individual radiobutton field and label.
        /// This consists of an html table cell &gt;td&lt; for the radiobutton, and another for the label.
        /// </summary>
        /// <param name="output"></param>
        /// <param name="id"></param>
        ...
        protected void Outputradiobutton(HtmlTextWriter output, string id, string text, string val, bool selected, int index)
        {
            output.Write("\t\t");
            output.Write("<td>");
            output.Write("<input type=\"radio\" name=\"");
            output.Write(id);
            output.Write("\" id=\"");
            ...
            output.Write(" class=\"");
            output.Write(this.radiobuttonCssClass);
            output.Write("\"");
            output.Write(">");
            output.Write("</td>");
        ...
        /// <summary>
        /// Returns the html needed for the opening table tag for the list of radiobuttones.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Retrieves a list of the radiobutton values that were selected (checked), if the form was submitted. 
        ...
        {
            // See what field name we are assigning to the radiobuttones
            GetHtmlFieldName();

            // Were any radiobuttones checked?
            if (HttpContext.Current.Request.Form[htmlFieldName] != null)
            {
                // Since we assigned the same field name to all of the radiobuttones,
                // ASP.NET will give us a comma-delimited list of the selections.
                // First, conver the list to a string array.
                selectedvalue = HttpContext.Current.Request.Form[htmlFieldName];
            }
        }
        ...
        /// <summary>
        /// Helper method to arrange the radiobutton items in a table with a variable number of columns.
        /// </summary>
