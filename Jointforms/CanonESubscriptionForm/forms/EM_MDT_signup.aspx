<%@ Page Inherits="CanonESubscriptionForm.forms.Handler" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>Canon Communications - EM and MDT Editorial Signup</title>
...
function validateForm() 
{
	...
	allOk = 
		...
		svValidator("City", document.forms[0].txtcity.value) && svValidator("Country", document.forms[0].drpcountry.value));
            ...
            <div id="container-content">
                <div id="banner">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="center">
                                <img border="0" src="http://www.kmpsgroup.com/images/EMD_sheader.gif" alt="">
                            </td>
                            <td align="center">
                                <h2>
                                    &nbsp;</h2>
                            ...
                            <td align="center">
                                <img border="0" src="http://www.kmpsgroup.com/images/MDT_sheader.gif" alt="">&nbsp;
                            </td>
                        </tr>
                    </table>
                    <br />
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td colspan="3" align="center">
                                <h1>
                                    Digital Product Subscription Form</h1>
                            </td>
                        </tr>
                    </table>
                </div>
                <form name="frmsub1" id="frmsub1" runat="server">
                    <div id="current">
                        ...
                        <div class="EM" style="height: 15em;">
                            <label>
                                TO SUBSCRIBE, please choose your options below (check all that apply).
                            </label>
                            <br />
                            <table width="100%" cellpadding="5" cellspacing="6" border="0">
                                <tr>
                                    <td valign="top">
                                        <input type="checkbox" value="y" name="user_EM_MDT_1"  id="user_EM_MDT_1" runat="server" />
                                    </td>
                                    <td valign="top">
                                        <b><i>European Med-Tech News E-Newsletter</i></b> - A monthly preview of the upcoming
                                        issues of <i>European Medical Device Manufacturer</i> and <i>Medical Device Technology</i>
                                        magazines.
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                        <input type="checkbox" value="y" name="user_EM_MDT_2"  id="user_EM_MDT_2" runat="server" />
                                    </td>
                                    <td valign="top">
                                ...
                                <tr>
                                    <td valign="top">
                                        <input type="checkbox" value="y" name="user_EM_MDT_3" id="user_EM_MDT_3" runat="server"  />
                                    </td>
                                    <td valign="top">
                                        <b><i>Technology Update </i></b>- Distributed three times a year, each <i>Technology
                                            Update</i> provides in-depth information on a specific product and service category
                                        relevant to medical manufacturing.
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                        <input type="checkbox" value="y" name="user_EM_MDT_4"  id="user_EM_MDT_4" runat="server" />
                                    </td>
                                    <td valign="top">
                                        <b><i>European Trade Show Advisor </i></b>- (MEDTEC UK, MEDTEC Stuttgart, MEDTEC
                                        Ireland) - Distributed before each event to preregistered attendees and subscribers,
                                        the <i>Trade Show Advisor</i> provides an electronic preview of the exhibition and
                                        conference, along with helpful travel tips.
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <p>
                                <label>
                                    * City:</label><asp:TextBox runat="server" ID="txtcity" Width="200"></asp:TextBox>
                                    ...
                                    <asp:DropDownList ID="drpstate" runat="server" Visible=false></asp:DropDownList>
                            </p>
                         <p class="country">
                                <label>
                                    Country:</label>
