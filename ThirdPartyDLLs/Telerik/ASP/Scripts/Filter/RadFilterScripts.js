...
var b="";
if(e.className.indexOf("rfOper")!==-1){b="ChangeGroupOperator";
}else{if(e.className.indexOf("rfExp")!==-1){b="ChangeFilterFunction";
}else{if(e.className.indexOf("rfField")!==-1){b="ChangeExpressionFieldName";
}}}if(b===""){return;
...
}},get_rippleZonesConfiguration:function(){return[{element:this.get_element(),rippleConfigurations:[{containerSelector:".rfTools a, .rfMid a, .rfApply a"}]}];
