...
var g=(f&&o<f)||d&&(o>d);
if(o<=0||g||(k>=this._ownerElement.offsetWidth&&this._column._owner._clientSettings._resizing._resizeMode!=Telerik.Web.UI.TreeListResizeMode.AllowScroll)){this._rightResizer.style.left=j;
return;
