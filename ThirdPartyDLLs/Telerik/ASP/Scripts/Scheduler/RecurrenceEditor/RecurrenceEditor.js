...
},_setIsRecurring:function(g){if(this._getRecurrentCheckBox()){this._getRecurrentCheckBox().checked=g;
...
},_setIsRecurring:function(g){if(!g){this._getControl("RecurrentAppointmentDropDown").findItemByText("Never").select();
