...
},get_rippleZonesConfiguration:function(){return[{element:a(".k-zoom-control",this.get_element())[0],rippleConfigurations:[{containerSelector:".k-button"}]},{element:a(".k-navigator",this.get_element())[0],rippleConfigurations:[{containerSelector:".k-button",rippleType:b.MaterialRippleType.Icon,iconRippleSizeFactor:0.35}]}];
