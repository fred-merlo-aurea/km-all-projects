...
{
    /// <summary>
    /// Unit Tests for <see cref="Frequency"/>
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public class FrequencyTest
    {
        private const string ProcSelect = "e_Frequency_Select";
        private const string MethodGet = "Get";
        private static readonly ClientConnections Client = new ClientConnections();

        private IDisposable _context;
        private IList<Entity.Frequency> _list;
        private Entity.Frequency _objWithRandomValues;
        private Entity.Frequency _objWithDefaultValues;
        ...
        public void SetUp()
        {
            ...
            _objWithRandomValues = typeof(Entity.Frequency).CreateInstance();
            _objWithDefaultValues = typeof(Entity.Frequency).CreateInstance(true);

            _list = new List<Entity.Frequency>
            {
        ...
        {
            // Arrange, Act
            var result = Frequency.Select(Client);
        ...
        {
            // Arrange, Act
            var result = typeof(Frequency).CallMethod(MethodGet, new object[] { new SqlCommand() });
