...
{
    /// <summary>
    /// Unit tests for <see cref="PaidBillTo"/>
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public class PaidBillToTest
    {
        private const string CommandText = "e_PaidBillTo_Save";

        private IDisposable _context;
        private SqlCommand _saveCommand;
        private Entity.PaidBillTo _bill;
        ...
        {
            // Arrange
            _bill = typeof(Entity.PaidBillTo).CreateInstance();

            // Act
            PaidBillTo.Save(_bill, new ClientConnections());
        ...
        {
            // Arrange
            _bill = typeof(Entity.PaidBillTo).CreateInstance(true);
        ...
        private void VerifySqlParameters()
        {
            _saveCommand.ShouldSatisfyAllConditions(
                ...
                () => _saveCommand.Parameters["@PhoneExt"].Value.ShouldBe((object) _bill.PhoneExt ?? DBNull.Value),
                ...
                () => _saveCommand.Parameters["@DateUpdated"].Value.ShouldBe((object) _bill.DateUpdated ?? DBNull.Value),
                () => _saveCommand.Parameters["@CreatedByUserID"].Value.ShouldBe(_bill.CreatedByUserID),
                () => _saveCommand.Parameters["@UpdatedByUserID"].Value.ShouldBe((object) _bill.UpdatedByUserID ?? DBNull.Value));
        }
