...
using ServiceImportErrorSummary = UAD_WS.Service.ImportErrorSummary;
...
namespace UAS.UnitTests.UAD_WS.Service
{
    ...
    public class ImportErrorSummaryTest : Fakes
    {
        private const int SampleId = 100;
        private const string SampleString = "dummy";

        private ServiceImportErrorSummary _testEntity;
        ...
        public void Setup()
        {
            SetupFakes();
            ShimForAuthenticate();
            _testEntity = new ServiceImportErrorSummary();
        }
