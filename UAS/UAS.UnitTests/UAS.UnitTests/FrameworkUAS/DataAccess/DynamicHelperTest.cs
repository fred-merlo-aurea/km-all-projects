...
namespace UAS.UnitTests.FrameworkUAS.DataAccess
{
    ...
    public class DynamicHelperTest : Fakes
    {
        ...
        public void GetList_WithSqlCommandAndConnectionString_ReturnsList()
        {
            ...
            // Act
            var result = DynamicHelper.GetList<SampleClass>(_sqlCommand, SampleString);
        ...
        public void GetList_WithSqlCommandAndClientConnection_ReturnsList()
        {
            ...
            // Act
            var result = DynamicHelper.GetList<SampleClass>(_sqlCommand, new ClientConnections());
