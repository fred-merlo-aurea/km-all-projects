...
using ServiceSplitTransform = UAS_WS.Service.SplitTransform;
...
namespace UAS.UnitTests.UAS_WS.Service
{
    ...
    public class SplitTransformTest : Fakes
    {
        ...
        public void Setup()
        {
            SetupFakes();
            ShimForAuthenticate();
            _testEntity = new ServiceSplitTransform();
        }
