...
{
    [TestFixture]
    public class LoadFileDataSetTest : Fakes
    {
        [Test]
        public void LoadFileDataSet_EmptyFile_NoRecords()
        {
            // Arrange, Act
            var dataSet = FileImporter.LoadFileDataSet(FileInfo1, null);
            ...
            dtCounts.Rows[0][FieldCountsTotalRows].ShouldBe(0);
            dtCounts.Rows[0][FieldCountsRowImportCount].ShouldBe(0);
            dtCounts.Rows[0][FieldCountsRowErrorCount].ShouldBe(1);
        }

        [Test]
        public void LoadFileDataSet_FilledFile1ColRow_RecordsFilled()
        {
            // Arrange
            FillFileCol2RowCol1();
        ...
        [Test]
        public void LoadFileDataSet_FilledFile2ColRow_RecordsFilled()
        {
            // Arrange
            FillFileCol2RowCol2();
