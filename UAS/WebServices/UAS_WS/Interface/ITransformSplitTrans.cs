...
namespace UAS_WS.Interface
{
    ...
    public interface ITransformSplitTrans
    {
        ...
        /// <returns></returns>
        [OperationContract]
        Response<List<FrameworkUAS.Entity.TransformSplitTrans>> SelectSourceFileID(Guid accessKey, int sourceFileID);
        ...
        Response<List<FrameworkUAS.Entity.TransformSplitTrans>> Select(Guid accessKey, int TransformationID);
