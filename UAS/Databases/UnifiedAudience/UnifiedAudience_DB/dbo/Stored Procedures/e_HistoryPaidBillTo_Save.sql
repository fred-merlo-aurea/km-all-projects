...
BEGIN
	...
	INSERT INTO HistoryPaidBillTo (PaidBillToID,SubscriptionPaidID,PubSubscriptionID,FirstName,LastName,Company,Title,AddressTypeID,Address1,Address2,Address3,City,RegionCode,RegionID,ZipCode,Plus4,
			...
			VALUES(@PaidBillToID,@SubscriptionPaidID,@PubSubscriptionID,@FirstName,@LastName,@Company,@Title,@AddressTypeID,@Address1,@Address2,@Address3,@City,@RegionCode,@RegionID,@ZipCode,@Plus4,@CarrierRoute,@County,
