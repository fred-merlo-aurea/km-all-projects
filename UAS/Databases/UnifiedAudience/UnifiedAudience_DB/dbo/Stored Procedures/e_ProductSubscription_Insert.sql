CREATE PROCEDURE [dbo].[e_ProductSubscription_Insert]
@SubscriptionID int,
@PubID int,
@demo7 varchar(1),
...
BEGIN
	...
	VALUES(@SubscriptionID,@PubID,@Demo7,@QualificationDate,@PubQSourceID,@PubCategoryID,@PubTransactionID,@EmailStatusID,@StatusUpdatedDate,@StatusUpdatedReason,@Email,@DateCreated,@DateUpdated,
		@CreatedByUserID,@UpdatedByUserID,@IsComp,@SubscriptionStatusID,@AddRemoveID,@Copies,@GraceIssues,@IMBSEQ,@IsActive,@IsPaid,@IsSubscribed,@MemberGroup,@OnBehalfOf,@OrigsSrc,@Par3C,
		@SequenceID,@Status,@SubscriberSourceCode,@SubSrc,@Verified,@ExternalKeyID,@FirstName,@LastName,@Company,@Title,@Occupation,@AddressTypeID,@Address1,@Address2,@Address3,@City,@RegionCode,@RegionID,@ZipCode,@Plus4,@CarrierRoute,@County,
