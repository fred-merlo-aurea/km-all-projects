CREATE PROCEDURE [dbo].[o_FinalizeBatch_SelectAll_NoUser_BatchID]
@BatchID int
AS
BEGIN
	...
	WHERE b.BatchID = @BatchID
	group by b.BatchID,c.ClientId,c.DisplayName, b.PublicationID, p.PubName, p.PubCode, u.UserName, b.DateCreated, b.DateFinalized,b.BatchNumber, b.BatchID, b.UserID
