...
BEGIN
	...
	IF EXISTS(SELECT * FROM PaidBillTo with(nolock) WHERE PubSubscriptionID = @PubSubscriptionID)
		BEGIN
			...
			SET 
				...
				SubscriptionPaidID = @SubscriptionPaidID
	...
	ELSE
		BEGIN
			IF @DateCreated IS NULL
				...
				END
			INSERT INTO PaidBillTo (SubscriptionPaidID,PubSubscriptionID,FirstName,LastName,Company,Title,AddressTypeID,Address1,Address2,Address3,City,RegionCode,RegionID,ZipCode,Plus4,CarrierRoute,County,
			...
			VALUES(@SubscriptionPaidID,@PubSubscriptionID,@FirstName,@LastName,@Company,@Title,@AddressTypeID,@Address1,@Address2,@Address3,@City,@RegionCode,@RegionID,@ZipCode,@Plus4,@CarrierRoute,@County,
					@Country,@CountryID,@Latitude,@Longitude,@IsAddressValidated,@AddressValidationDate,@AddressValidationSource,@AddressValidationMessage,@Email,@Phone,@PhoneExt,@Fax,@Mobile,
