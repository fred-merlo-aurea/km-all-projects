CREATE PROCEDURE [dbo].[job_ListSource_2yr]
...
BEGIN
	...
	declare @ListSourceYear int = 2 - 1 --Subtract one because the code to get start and end date is already considered 1yr
