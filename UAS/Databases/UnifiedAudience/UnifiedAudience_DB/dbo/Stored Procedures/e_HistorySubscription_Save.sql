	...
	ELSE
		BEGIN
			...
			INSERT INTO HistorySubscription([PubSubscriptionID],[SubscriptionID],[PubID],[Demo7],[QualificationDate],[PubQSourceID],[PubCategoryID],[PubTransactionID],[EmailStatusID],[StatusUpdatedDate],[StatusUpdatedReason],
				...
				IsInActiveWaveMailing, WaveMailingID, IGrp_No, SFRecordIdentifier, SubGenSubscriberID,MailPermission, FaxPermission, PhonePermission, OtherProductsPermission, EmailRenewPermission, 
				ThirdPartyPermission, TextPermission)
			VALUES(@PubSubscriptionID,@SubscriptionID,@PubID,@Demo7,@QualificationDate,@PubQSourceID,@PubCategoryID,@PubTransactionID,@EmailStatusID,@StatusUpdatedDate,@StatusUpdatedReason,@Email,@DateCreated,GETDATE(),
				...
				@IsInActiveWaveMailing, @WaveMailingID, @IGrp_No, @SFRecordIdentifier, @SubGenSubscriberID,@MailPermission, @FaxPermission, @PhonePermission, @OtherProductsPermission, 
				@EmailRenewPermission, @ThirdPartyPermission, @TextPermission);SELECT @@IDENTITY;
		END
