	...
	ELSE
		BEGIN
			IF @DateCreated IS NULL
				...
				INSERT INTO IssueCompDetail (IssueCompDetailId,IssueCompID,[PubID],[Demo7],[QualificationDate],[PubQSourceID],[PubCategoryID],[PubTransactionID],[EmailStatusID],[StatusUpdatedDate],[StatusUpdatedReason],
					...
					IsInActiveWaveMailing, WaveMailingID, IGrp_No, SFRecordIdentifier, ReqFlag)
				VALUES(@IssueCompDetailId,@IssueCompID,@PubID,@Demo7,@QualificationDate,@PubQSourceID,@PubCategoryID,@PubTransactionID,@EmailStatusID,@StatusUpdatedDate,@StatusUpdatedReason,@Email,@DateCreated,@DateUpdated,
					...
					@IsInActiveWaveMailing, @WaveMailingID, @IGrp_No, @SFRecordIdentifier, @ReqFlag);SELECT @@IDENTITY;
		END
