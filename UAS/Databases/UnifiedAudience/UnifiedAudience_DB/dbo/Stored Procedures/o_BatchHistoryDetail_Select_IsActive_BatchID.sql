CREATE PROCEDURE [dbo].[o_BatchHistoryDetail_Select_IsActive_BatchID]
	@IsActive bit,
...
BEGIN
		...
		Select UserLogID, UserLogTypeID, [Object], FromObjectValues, ToObjectValues, DateCreated
			...
			(
				...
				from Batch b With(NoLock)
					...
					where b.IsActive = @IsActive and b.BatchID = @BatchID and htul.UserLogID is not null		
			)
	END
	else
	BEGIN
	...
	WHERE b.IsActive = @IsActive and htul.UserLogID != h.HistorySubscriptionID and b.BatchID = @BatchID
