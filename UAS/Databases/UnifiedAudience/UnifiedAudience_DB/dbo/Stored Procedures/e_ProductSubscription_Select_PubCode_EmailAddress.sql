CREATE PROCEDURE [dbo].[e_ProductSubscription_Select_PubCode_EmailAddress]
@PubCode varchar(50),
...
BEGIN
	...
	WHERE ps.SubscriptionID IN (SELECT SubscriptionID FROM Subscriptions WHERE EMAIL = @EmailAddress) AND ps.PubID = @PubID
