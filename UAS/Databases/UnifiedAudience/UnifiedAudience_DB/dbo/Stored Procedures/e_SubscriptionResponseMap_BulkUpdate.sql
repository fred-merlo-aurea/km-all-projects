...
BEGIN
	...
	FROM #import i 
		INNER JOIN SubscriptionResponseMap srm ON srm.SubscriptionID = i.SubscriptionID
	...
	DELETE 
	FROM SubscriptionResponseMap 
	WHERE IsActive = 0 and SubscriptionID IN (SELECT SubscriptionID FROM #import GROUP BY SubscriptionID)
