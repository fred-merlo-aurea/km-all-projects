CREATE TABLE [dbo].[IssueArchivePubSubscriptionsExtension] (
    [IssueArchiveSubscriptionID] INT    NOT NULL,
    ...
    CONSTRAINT [PK_ArchivePubSubscriptionsExtension] PRIMARY KEY CLUSTERED ([IssueArchiveSubscriptionID] ASC) WITH (FILLFACTOR = 90)
);
