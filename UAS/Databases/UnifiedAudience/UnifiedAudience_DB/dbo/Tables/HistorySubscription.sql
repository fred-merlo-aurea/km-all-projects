CREATE TABLE [dbo].[HistorySubscription] (
    ...
    [IsAddressValidated]       BIT              NULL  DEFAULT ((0)) ,
    ...
    CONSTRAINT [PK_HistorySubscription] PRIMARY KEY CLUSTERED ([HistorySubscriptionID] ASC) WITH (FILLFACTOR = 90)
);
GO

CREATE NONCLUSTERED INDEX [IX_HistorySubscription_PubSubscriptionID]
    ON [dbo].[HistorySubscription]([PubSubscriptionID] ASC);
GO

CREATE NONCLUSTERED INDEX [IX_HistorySubscription_SubscriptionID]
    ON [dbo].[HistorySubscription]([SubscriptionID] ASC);
GO
