CREATE TABLE [dbo].[SubscriptionPaid] (
    ...
    CONSTRAINT [PK_SubscriptionPaid] PRIMARY KEY CLUSTERED ([SubscriptionPaidID] ASC) WITH (FILLFACTOR = 90)
);
GO

CREATE NONCLUSTERED INDEX [IX_SubscriptionPaid_PubSubscriptionID]
    ON [dbo].[SubscriptionPaid]([PubSubscriptionID] ASC);
GO
