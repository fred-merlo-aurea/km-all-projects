CREATE TABLE [dbo].[SubscriberOriginal] (
    [SubscriberOriginalID] INT              IDENTITY (1, 1) NOT NULL,
    ...
    [DateCreated]          DATETIME         CONSTRAINT [DF_SubscriberOriginal_DateCreated] DEFAULT (getdate()) NULL,
    ...
    CONSTRAINT [PK_SubscriberOriginal] PRIMARY KEY CLUSTERED ([SORecordIdentifier] ASC)
);


GO

CREATE NONCLUSTERED INDEX [idx_SubscriberOriginal_ProcessCode_SourceFileID_SORecordIdentifier] ON [dbo].[SubscriberOriginal] 
(
	[ProcessCode] ASC,
	[SourceFileID] ASC,
