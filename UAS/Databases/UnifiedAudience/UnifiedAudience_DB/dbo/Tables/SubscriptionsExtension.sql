CREATE TABLE [dbo].[SubscriptionsExtension] (
    ...
    CONSTRAINT [PK_SubscriptionsExtension] PRIMARY KEY CLUSTERED ([SubscriptionID] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [FK_SubscriptionsExtension_Subscriptions] FOREIGN KEY ([SubscriptionID]) REFERENCES [dbo].[Subscriptions] ([SubscriptionID])
);
