CREATE PROCEDURE dc_LikeProfileInsertDetail
@dcResultQueId int,
...
BEGIN
	...
	declare @dcOptId int = (select DataCompareOptionId from DataCompareOption with(nolock) where OptionName = 'Like Profiles')
