...
create PROCEDURE [dbo].[sp_IndexAnalysis]
    ...
    @showAction varchar(50) = null,
    @showMissingIndexOnly bit = false 
    )
AS
BEGIN
	...
	BEGIN TRY
		...
		and (@showAction is null or index_action = @showAction)
		and (@showMissingIndexOnly = 0 or  index_name = '--MISSING--')
