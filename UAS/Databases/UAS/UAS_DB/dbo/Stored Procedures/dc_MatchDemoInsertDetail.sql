CREATE PROCEDURE dc_MatchDemoInsertDetail
@dcResultQueId int,
...
BEGIN
	...
	declare @dcOptId int = (select DataCompareOptionId from DataCompareOption with(nolock) where OptionName = 'Matching Demographics')
