...
INSERT INTO HistoryPaid (SubscriptionPaidID,SubscriptionID,PriceCodeID,StartIssueDate,ExpireIssueDate,CPRate,Amount,AmountPaid,
...
VALUES(@SubscriptionPaidID,@SubscriptionID,@PriceCodeID,@StartIssueDate,@ExpireIssueDate,@CPRate,@Amount,@AmountPaid,
	   @BalanceDue,@PaidDate,@TotalIssues,@CheckNumber,@CCNumber,@CCExpirationMonth,@CCExpirationYear,@CCHolderName,
