namespace ReportLibrary.Reports
{
	partial class CategorySummary
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CategorySummary));
            ...
            // CatSummary
            // 
            this.CatSummary.ConnectionString = "Data Source=.\\D2008R2;Initial Catalog=MTGMasterDB;Integrated Security=True";
            ...
            this.CatSummary.SelectCommand = "dbo.rpt_CategorySummary";
            ...
            "ray(\"CategoryCode\", \"Demo7\"), Array(Fields.CategoryCodeID, Fields.DemoID))"));
            instanceReportSource1.Parameters.Add(new Telerik.Reporting.Parameter("ProductName", "= Parameters.ProductName.Value"));
            instanceReportSource1.Parameters.Add(new Telerik.Reporting.Parameter("ParentReport", "= \"Category Summary - \" + Fields.CategoryType + \" Subscriber Details\""));
            ...
            reportParameter3.Name = "Filters";
            reportParameter3.Value = "<XML><Filters><ProductID>3</ProductID><CategoryCode>101,102,103,115,116,117,118,1" +
    "19,120,121,122</CategoryCode><TransactionType>1,3</TransactionType></Filters></X" +
    "ML>";
            reportParameter4.Name = "AdHocFilters";
            reportParameter4.Text = "AdHocFilters";
            reportParameter4.Value = "<XML></XML>";
