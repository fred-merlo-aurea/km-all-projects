namespace ReportLibrary.Reports
{
	partial class SubFields
	{
		...
		private void InitializeComponent()
		{
            ...
            // Demo
            // 
            this.Demo.ConnectionString = "Data Source=.\\D2008R2;Initial Catalog=MTGMasterDB;Integrated Security=True";
            this.Demo.Name = "Demo";
            ...
            this.Demo.SelectCommand = "dbo.rpt_SubFields";
            ...
            this.DemoTable.Body.Rows.Add(new Telerik.Reporting.TableBodyRow(Telerik.Reporting.Drawing.Unit.Inch(0.20000001788139343D)));
            this.DemoTable.Body.Rows.Add(new Telerik.Reporting.TableBodyRow(Telerik.Reporting.Drawing.Unit.Inch(0.20000001788139343D)));
            ...
            // textBox4
            // 
            instanceReportSource1.Parameters.Add(new Telerik.Reporting.Parameter("Filters", "= IIf(Fields.DemoID > 0,ReportLibrary.Reports.ReportUtilities.GetXMLFilter(Parame" +
            "ters.Filters.Value, Array(\"Demo7\"),\r\nArray(Fields.DemoID)), Parameters.Filters.V" +
            "alue)"));
            instanceReportSource1.Parameters.Add(new Telerik.Reporting.Parameter("AdHocFilters", "= IIf(Fields.DemoID = 0, ReportLibrary.Reports.ReportUtilities.GetStandardAdHocFi" +
            "lter(Parameters.AdHocFilters.Value, Array(\"Demo7\"), Array(\"\"), Array(\"No Respons" +
            "e\")), Parameters.AdHocFilters.Value)"));
            ...
            this.textBox15.Value = "=Parameters.IssueName";
            // 
            // textBox12
            // 
            ...
            reportParameter1.Value = "<XML><Filters><ProductID>1</ProductID><StateIDs>MN</StateIDs></Filters></XML>";
            reportParameter2.Name = "Demo";
            reportParameter2.Text = "Demo";
            reportParameter2.Value = "DEMO7";
