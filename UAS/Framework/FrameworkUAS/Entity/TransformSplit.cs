    ...
    public class TransformSplit
    {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hash = hash * mult + TransformSplitID.GetHashCode();
        ...
        {
            return Equals(obj as TransformSplit);
        }
        public bool Equals(TransformSplit other)
        {
            // Check for null
            ...
            return (TransformSplitID == other.TransformSplitID &&
