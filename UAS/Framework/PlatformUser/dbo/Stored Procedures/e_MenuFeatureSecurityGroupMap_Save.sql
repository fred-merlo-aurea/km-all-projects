...
ELSE
	BEGIN
		IF @DateCreated IS NULL
			...
			END
		INSERT INTO MenuFeatureSecurityGroupMap (MenuFeatureID,SecurityGroupID,HasAccess,DateCreated,CreatedByUserID)
		VALUES(@MenuFeatureID,@SecurityGroupID,@HasAccess,@DateCreated,@CreatedByUserID);SELECT @@IDENTITY;
	END
