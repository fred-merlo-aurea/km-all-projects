...
GO
EXECUTE sp_addrolemember @rolename = N'Developer', @membername = N'Corwin.brust';


GO
EXECUTE sp_addrolemember @rolename = N'Developer', @membername = N'Micah.Matheson';


GO
EXECUTE sp_addrolemember @rolename = N'Developer', @membername = N'Elena.Erofeeva';
...
GO
EXECUTE sp_addrolemember @rolename = N'Developer', @membername = N'Charles.Vashaw';
