...
namespace FrameworkUAD.Entity
{
    [Serializable]
    [DataContract]
    public class SubscriberDemographicOriginal : ISubscriberDemographic
    {
        public SubscriberDemographicOriginal() 
        {
            SDOriginalID = 0;
            PubID = 0;
        ...
        #region Properties
        [DataMember]
        public int SDOriginalID { get; set; }
        [DataMember]
        ...
        {
            return Equals(obj as SubscriberDemographicOriginal);
        }
        public bool Equals(SubscriberDemographicOriginal other)
        {
            // Check for null
