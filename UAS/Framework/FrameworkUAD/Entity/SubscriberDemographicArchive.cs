...
namespace FrameworkUAD.Entity
{
    ...
    {
        public SubscriberDemographicArchive() 
        {
            SDArchiveID = 0;
            PubID = 0;
            SARecordIdentifier = Guid.Empty;
        ...
        #region Properties
        [DataMember]
        public int SDArchiveID { get; set; }
        [DataMember]
        ...
        {
            return Equals(obj as SubscriberDemographicArchive);
        }
        public bool Equals(SubscriberDemographicArchive other)
        {
            // Check for null
