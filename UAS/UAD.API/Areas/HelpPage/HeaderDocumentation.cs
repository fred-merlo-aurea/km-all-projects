...
using HeaderDocumentationLibrary = System.Collections.Generic.Dictionary<string, UAD.API.Areas.HelpPage.HeaderDocumentation>;
...
namespace UAD.API.Areas.HelpPage
{
    public class HeaderDocumentation
    {
        ...
        [Flags]
        public enum HeaderApplicabilityFlags { Request, Response }
